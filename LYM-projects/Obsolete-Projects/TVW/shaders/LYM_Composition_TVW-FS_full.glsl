...
uniform vec4 uniform_Composition_fs_4fv_echo_echoNeg_trackCompositionWeight_0_trackCompositionWeight_1;
float     CACompositionWeight;
uniform float uniform_Composition_fs_1fv_CACompositionWeight;
...
uniform vec2 uniform_Composition_fs_2fv_flashVideoCoef_flashVideoThreshold;
...
// DISPLAY MESSAGE
layout (binding = 8) uniform samplerRect fs_lookupTable_display_font;
layout (binding = 9) uniform samplerRect fs_lookupTable_display_msg1_offset;
layout (binding = 10) uniform samplerRect fs_lookupTable_display_msg2_offset;
...
void main() {
  echo = uniform_Composition_fs_4fv_echo_echoNeg_trackCompositionWeight_0_trackCompositionWeight_1[0];
  echoNeg = uniform_Composition_fs_4fv_echo_echoNeg_trackCompositionWeight_0_trackCompositionWeight_1[1];
  trackCompositionWeight_0 = uniform_Composition_fs_4fv_echo_echoNeg_trackCompositionWeight_0_trackCompositionWeight_1[2];
  trackCompositionWeight_1 = uniform_Composition_fs_4fv_echo_echoNeg_trackCompositionWeight_0_trackCompositionWeight_1[3];
  CACompositionWeight = uniform_Composition_fs_1fv_CACompositionWeight;
  ...
  // float kernelX = -3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,1)))
  //                 + 3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,1)))
  //                 + -10 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,0)))
  //                 + 10 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,0)))
  //                 + -3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,-1)))
  //                 + 3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,-1)));
  // float kernelY = -3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,1)))
  //                 + 3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,-1)))
  //                 + -10 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(0,1)))
  //                 + 10 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(0,-1)))
  //                 + -3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,1)))
  //                 + 3 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,-1)));
  // float kernelX = -1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,1)))
  //                 + 1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,1)))
  //                 + -2 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,0)))
  //                 + 2 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,0)))
  //                 + -1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,-1)))
  //                 + 1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,-1)));
  // float kernelY = -1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,1)))
  //                 + 1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(-1,-1)))
  //                 + -2 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(0,1)))
  //                 + 2 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(0,-1)))
  //                 + -1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,1)))
  //                 + 1 * graylevel(texture(fs_lookupTable2, decalCoords + vec2(1,-1)));
  ...
  // drawing and GOL combination
      ...
      float flashVideoCoef = uniform_Composition_fs_2fv_flashVideoCoef_flashVideoThreshold.x;
      float flashVideoThreshold = uniform_Composition_fs_2fv_flashVideoCoef_flashVideoThreshold.y;
  ...
  if( ( alphaText1 > 0 || alphaText2 > 0 ) && decalCoords.y < 60 ) { // && displayMsgPosition >= 0 ) {
    ...
    vec4 offset1 = texture(fs_lookupTable_display_msg1_offset, vec2(locDecalCoord.x,0) ) * 255.0;
    vec4 offset2 = texture(fs_lookupTable_display_msg2_offset, vec2(locDecalCoord.x,0) ) * 255.0;
    ...
    if( locDecalCoord.y > offset1.w && locDecalCoord.y < offset1.w + offset1.z && locDecalCoord.x >= 0 ) {
       fontC1 = texture(fs_lookupTable_display_font, vec2(offset1.x , locDecalCoord.y - offset1.w + offset1.y)).rgb;
    }
    if( locDecalCoord.y > offset2.w && locDecalCoord.y < offset2.w + offset2.z  && locDecalCoord.x >= 0 ) {
      fontC2 = texture(fs_lookupTable_display_font, vec2(offset2.x , locDecalCoord.y - offset2.w + offset2.y)).rgb;
    }
