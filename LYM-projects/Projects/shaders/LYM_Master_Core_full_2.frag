...
void main() {
  ...
  currentMaskTrack = int(uniform_Master_scenario_var_data[15]);
  ...
  SecondMasterMixingWeight = uniform_Master_scenario_var_data[29];
  master_mask_opacity_6 = uniform_Master_scenario_var_data[30];
