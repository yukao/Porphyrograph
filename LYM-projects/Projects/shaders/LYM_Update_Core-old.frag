...
#include_initializations
 ...
 // cursor type (+1 for stylus and -1 for rubber)
  ...
  if(photoWeight * uniform_Update_fs_2fv_clip01Wghts.x > 0) {
    ...
    coordsImageScaled = coordsImage / photo_scale + vec2(0.5) * uniform_Update_fs_4fv_photo01_wh.xy * (photo_scale - 1) / photo_scale;
    // coordsImageScaled = coordsImage;
    photoOriginal = texture(uniform_Update_texture_fs_Clip0, coordsImageScaled ).rgb;
    photocolor += photoWeight * uniform_Update_fs_2fv_clip01Wghts.x * photoOriginal;
  ...
  if(photoWeight * uniform_Update_fs_2fv_clip01Wghts.y > 0) {
    ...
    coordsImageScaled = coordsImage / photo_scale + vec2(0.5) * uniform_Update_fs_4fv_photo01_wh.zw * (photo_scale - 1) / photo_scale;
    // coordsImageScaled = coordsImage;
    photoOriginal = texture(uniform_Update_texture_fs_Clip1, coordsImageScaled ).rgb;
    photocolor += photoWeight * uniform_Update_fs_2fv_clip01Wghts.y * photoOriginal;
  ...
  if( currentPhotoSource != 0 && photoSobel > 0 ) {
      ...
      switch(currentPhotoSource) {
        ...
        case 2:
          ...
          break;
        case 3:
          photocolor = photoWeight * uniform_Update_fs_2fv_clip01Wghts.x * photo_sobel_result;
          break;
        case 4:
          photocolor = photoWeight * uniform_Update_fs_2fv_clip01Wghts.y * photo_sobel_result;
          break;
      }
  }
