...
void main() {
  ...
  trackMixingWeight_2 = uniform_Mixing_scenario_var_data[3];
  trackMixingWeight_3 = uniform_Mixing_scenario_var_data[4];
  echo = uniform_Mixing_scenario_var_data[5];
  echoNeg = uniform_Mixing_scenario_var_data[6];
