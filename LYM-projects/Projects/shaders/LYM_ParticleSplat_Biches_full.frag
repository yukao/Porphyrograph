...
#version 420
// comet texture
layout (binding = 2) uniform sampler2D uniform_ParticleSplat_BlurredDisk_texture_fs_decal; // control point positions
...
void main() {
	 ...
	 fColor.rgb = fColor.rgb * 0.5 + VertexIn.color * 0.5;
