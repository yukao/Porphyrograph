...
void main() {
  ...
  pixel_image_acceleration = int(uniform_Update_scenario_var_data[8]);
  ...
  invertPhoto = (uniform_Update_scenario_var_data[33] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[34];
  video_value = uniform_Update_scenario_var_data[35];
  movie_gamma = uniform_Update_scenario_var_data[36];
  movie_threshold = uniform_Update_scenario_var_data[37];
  video_gamma = uniform_Update_scenario_var_data[38];
  video_threshold = uniform_Update_scenario_var_data[39];
  video_contrast = uniform_Update_scenario_var_data[40];
  photoWeight = uniform_Update_scenario_var_data[41];
  photo_satur = uniform_Update_scenario_var_data[42];
  photo_value = uniform_Update_scenario_var_data[43];
  photo_gamma = uniform_Update_scenario_var_data[44];
  photo_threshold = uniform_Update_scenario_var_data[45];
  photoSobel = uniform_Update_scenario_var_data[46];
  photo_scaleX = uniform_Update_scenario_var_data[47];
  photo_scaleY = uniform_Update_scenario_var_data[48];
  photo_rot = uniform_Update_scenario_var_data[49];
  photo_transl_x = uniform_Update_scenario_var_data[50];
  photo_transl_y = uniform_Update_scenario_var_data[51];
  mask_scale = uniform_Update_scenario_var_data[52];
  photo_contrast = uniform_Update_scenario_var_data[53];
  mask_contrast = uniform_Update_scenario_var_data[54];
  CAParams1 = uniform_Update_scenario_var_data[55];
  CAParams2 = uniform_Update_scenario_var_data[56];
  CAParams3 = uniform_Update_scenario_var_data[57];
  CAParams4 = uniform_Update_scenario_var_data[58];
  CAParams5 = uniform_Update_scenario_var_data[59];
  CAParams6 = uniform_Update_scenario_var_data[60];
  CAParams7 = uniform_Update_scenario_var_data[61];
  CAParams8 = uniform_Update_scenario_var_data[62];
  CAstep = int(uniform_Update_scenario_var_data[63]);
  Pixelstep = int(uniform_Update_scenario_var_data[64]);
  CAcolorSpread = (uniform_Update_scenario_var_data[65] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[66] > 0 ? true : false);
  video_white = uniform_Update_scenario_var_data[67];
  video_hue = uniform_Update_scenario_var_data[68];
  photo_hue = uniform_Update_scenario_var_data[69];
  invertCamera = (uniform_Update_scenario_var_data[70] > 0 ? true : false);
  cameraCumul = int(uniform_Update_scenario_var_data[71]);
  camera_BG_subtr = (uniform_Update_scenario_var_data[72] > 0 ? true : false);
  cameraGamma = uniform_Update_scenario_var_data[73];
  camera_gamma = uniform_Update_scenario_var_data[74];
  cameraThreshold = uniform_Update_scenario_var_data[75];
  cameraWeight = uniform_Update_scenario_var_data[76];
  cameraSobel = uniform_Update_scenario_var_data[77];
  noiseType = int(uniform_Update_scenario_var_data[78]);
  noiseLineScale = uniform_Update_scenario_var_data[79];
  noiseAngleScale = uniform_Update_scenario_var_data[80];
  noiseCenterX = uniform_Update_scenario_var_data[81];
  noiseCenterY = uniform_Update_scenario_var_data[82];
