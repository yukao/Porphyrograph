...
/*  float alpha = 1.0;
  ...
  if(coords.x < 1920 && coords.x > 1830) {
     alpha = 1.0 * (1920 - coords.x)/float(1920-1830);
  }
  if(coords.x >= 1920 && coords.x < 2030) {
     alpha = 1.0 * (coords.x - 1920)/float(2030-1920);
  }
  if(coords.x >= 1920) {
    coords.x = coords.x - 2132 + 1920;
  }
*/
