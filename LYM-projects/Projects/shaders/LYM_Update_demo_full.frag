...
int       currentSvgGpuLayers;
int       path_replay_trackNo_1;
int       path_replay_trackNo_2;
uniform vec4 uniform_Update_fs_4fv_currentPhotoTrack_currentSvgGpuLayers_path_replay_trackNo_1_path_replay_trackNo_2;
int       path_replay_trackNo_3;
int       path_replay_trackNo_4;
int       path_replay_trackNo_5;
int       path_replay_trackNo_6;
uniform vec4 uniform_Update_fs_4fv_path_replay_trackNo_3_path_replay_trackNo_4_path_replay_trackNo_5_path_replay_trackNo_6;
int       path_replay_trackNo_7;
float     CAdecay_pulse;
bool      invertMovie;
int       cameraCumul;
uniform vec4 uniform_Update_fs_4fv_path_replay_trackNo_7_CAdecay_pulse_invertMovie_cameraCumul;
float     cameraThreshold;
float     cameraGamma;
float     video_satur;
float     video_satur_pulse;
uniform vec4 uniform_Update_fs_4fv_cameraThreshold_cameraGamma_video_satur_video_satur_pulse;
float     cameraWeight;
float     movieWeight;
float     cameraSobel;
float     movieSobel;
...
void main() {
  ...
  currentPhotoTrack = int(uniform_Update_fs_4fv_currentPhotoTrack_currentSvgGpuLayers_path_replay_trackNo_1_path_replay_trackNo_2[0]);
  currentSvgGpuLayers = int(uniform_Update_fs_4fv_currentPhotoTrack_currentSvgGpuLayers_path_replay_trackNo_1_path_replay_trackNo_2[1]);
  path_replay_trackNo_1 = int(uniform_Update_fs_4fv_currentPhotoTrack_currentSvgGpuLayers_path_replay_trackNo_1_path_replay_trackNo_2[2]);
  path_replay_trackNo_2 = int(uniform_Update_fs_4fv_currentPhotoTrack_currentSvgGpuLayers_path_replay_trackNo_1_path_replay_trackNo_2[3]);
  ...
  path_replay_trackNo_6 = int(uniform_Update_fs_4fv_path_replay_trackNo_3_path_replay_trackNo_4_path_replay_trackNo_5_path_replay_trackNo_6[3]);
  path_replay_trackNo_7 = int(uniform_Update_fs_4fv_path_replay_trackNo_7_CAdecay_pulse_invertMovie_cameraCumul[0]);
  CAdecay_pulse = uniform_Update_fs_4fv_path_replay_trackNo_7_CAdecay_pulse_invertMovie_cameraCumul[1];
  invertMovie = (uniform_Update_fs_4fv_path_replay_trackNo_7_CAdecay_pulse_invertMovie_cameraCumul[2] > 0 ? true : false);
  cameraCumul = int(uniform_Update_fs_4fv_path_replay_trackNo_7_CAdecay_pulse_invertMovie_cameraCumul[3]);
  cameraThreshold = uniform_Update_fs_4fv_cameraThreshold_cameraGamma_video_satur_video_satur_pulse[0];
  cameraGamma = uniform_Update_fs_4fv_cameraThreshold_cameraGamma_video_satur_video_satur_pulse[1];
  video_satur = uniform_Update_fs_4fv_cameraThreshold_cameraGamma_video_satur_video_satur_pulse[2];
  video_satur_pulse = uniform_Update_fs_4fv_cameraThreshold_cameraGamma_video_satur_video_satur_pulse[3];
