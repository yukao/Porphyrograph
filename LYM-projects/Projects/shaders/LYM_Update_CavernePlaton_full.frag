...
bool	  CAcolorSpread;
bool	  freeze;
uniform float uniform_Update_scenario_var_data[66];
...
void main() {
  ...
  video_satur_pulse = uniform_Update_scenario_var_data[43];
  video_value = uniform_Update_scenario_var_data[44];
  photoWeight = uniform_Update_scenario_var_data[45];
  photo_satur = uniform_Update_scenario_var_data[46];
  photo_satur_pulse = uniform_Update_scenario_var_data[47];
  photo_value = uniform_Update_scenario_var_data[48];
  photo_value_pulse = uniform_Update_scenario_var_data[49];
  photo_scale = uniform_Update_scenario_var_data[50];
  mask_scale = uniform_Update_scenario_var_data[51];
  photo_contrast = uniform_Update_scenario_var_data[52];
  mask_contrast = uniform_Update_scenario_var_data[53];
  CAParams1 = uniform_Update_scenario_var_data[54];
  CAParams2 = uniform_Update_scenario_var_data[55];
  CAParams3 = uniform_Update_scenario_var_data[56];
  CAParams4 = uniform_Update_scenario_var_data[57];
  CAParams5 = uniform_Update_scenario_var_data[58];
  CAParams6 = uniform_Update_scenario_var_data[59];
  CAParams7 = uniform_Update_scenario_var_data[60];
  CAParams8 = uniform_Update_scenario_var_data[61];
  cameraCumul = int(uniform_Update_scenario_var_data[62]);
  CAstep = int(uniform_Update_scenario_var_data[63]);
  CAcolorSpread = (uniform_Update_scenario_var_data[64] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[65] > 0 ? true : false);
