/***********************************************************************
File: song/shaders/LYM_ParticleAnimation_song-VP.cg
...
uniform vec2 uniform_ParticleAnimation_vp_2fv_width_height;
...
void main() {
  ...
  decalCoordsPOT = texcoord/uniform_ParticleAnimation_vp_2fv_width_height;
}
