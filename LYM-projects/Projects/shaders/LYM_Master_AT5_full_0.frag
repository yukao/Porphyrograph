...
int		AT5_stop_motion;
uniform float uniform_Master_scenario_var_data[33];
...
void main() {
  ...
  AT5_shutter = uniform_Master_scenario_var_data[31];
  AT5_stop_motion = int(uniform_Master_scenario_var_data[32]);
  ...
  // SHUTTER
#if defined(var_AT5_shutter)
  if(coords.x < AT5_shutter || coords.x > width - AT5_shutter) {
