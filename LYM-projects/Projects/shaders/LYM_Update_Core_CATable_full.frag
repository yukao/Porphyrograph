...
void main() {
  ...
  invertPhoto = (uniform_Update_scenario_var_data[43] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[44];
  video_satur_pulse = uniform_Update_scenario_var_data[45];
  video_value = uniform_Update_scenario_var_data[46];
  video_gamma = uniform_Update_scenario_var_data[47];
  video_threshold = uniform_Update_scenario_var_data[48];
  movie_gamma = uniform_Update_scenario_var_data[49];
  movie_threshold = uniform_Update_scenario_var_data[50];
  photoWeight = uniform_Update_scenario_var_data[51];
  photo_satur = uniform_Update_scenario_var_data[52];
  photo_satur_pulse = uniform_Update_scenario_var_data[53];
  photo_value = uniform_Update_scenario_var_data[54];
  photo_value_pulse = uniform_Update_scenario_var_data[55];
  photo_gamma = uniform_Update_scenario_var_data[56];
  photo_gamma_pulse = uniform_Update_scenario_var_data[57];
  photo_threshold = uniform_Update_scenario_var_data[58];
  photoSobel = uniform_Update_scenario_var_data[59];
  ...
  video_white = uniform_Update_scenario_var_data[76];
