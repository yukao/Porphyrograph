...
#define var_freeze
bool	  freeze;
uniform float uniform_Update_scenario_var_data[47];
...
void main() {
  ...
  noiseUpdateScale = uniform_Update_scenario_var_data[9];
  pixel_acc = uniform_Update_scenario_var_data[10];
  pixel_acc_shiftX = uniform_Update_scenario_var_data[11];
  pixel_acc_shiftY = uniform_Update_scenario_var_data[12];
  pixel_radius = uniform_Update_scenario_var_data[13];
  pixel_mode = int(uniform_Update_scenario_var_data[14]);
  repop_CA = uniform_Update_scenario_var_data[15];
  repop_BG = uniform_Update_scenario_var_data[16];
  cameraGamma = uniform_Update_scenario_var_data[17];
  camera_gamma = uniform_Update_scenario_var_data[18];
  camera_contrast = uniform_Update_scenario_var_data[19];
  cameraThreshold = uniform_Update_scenario_var_data[20];
  cameraWeight = uniform_Update_scenario_var_data[21];
  cameraSobel = uniform_Update_scenario_var_data[22];
  invertCamera = (uniform_Update_scenario_var_data[23] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[24];
  video_value = uniform_Update_scenario_var_data[25];
  photoWeight = uniform_Update_scenario_var_data[26];
  photo_satur = uniform_Update_scenario_var_data[27];
  photo_value = uniform_Update_scenario_var_data[28];
  photo_gamma = uniform_Update_scenario_var_data[29];
  photo_threshold = uniform_Update_scenario_var_data[30];
  photo_scale = uniform_Update_scenario_var_data[31];
  mask_scale = uniform_Update_scenario_var_data[32];
  photo_contrast = uniform_Update_scenario_var_data[33];
  mask_contrast = uniform_Update_scenario_var_data[34];
  CAParams1 = uniform_Update_scenario_var_data[35];
  CAParams2 = uniform_Update_scenario_var_data[36];
  CAParams3 = uniform_Update_scenario_var_data[37];
  CAParams4 = uniform_Update_scenario_var_data[38];
  CAParams5 = uniform_Update_scenario_var_data[39];
  CAParams6 = uniform_Update_scenario_var_data[40];
  CAParams7 = uniform_Update_scenario_var_data[41];
  CAParams8 = uniform_Update_scenario_var_data[42];
  cameraCumul = int(uniform_Update_scenario_var_data[43]);
  CAstep = int(uniform_Update_scenario_var_data[44]);
  CAcolorSpread = (uniform_Update_scenario_var_data[45] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[46] > 0 ? true : false);
