...
void main() {
  ...
  noiseUpdateScale = uniform_Update_scenario_var_data[8];
  pixel_acc = uniform_Update_scenario_var_data[9];
  pixel_acc_shiftX = uniform_Update_scenario_var_data[10];
  pixel_acc_shiftY = uniform_Update_scenario_var_data[11];
  pixel_radius = uniform_Update_scenario_var_data[12];
  pixel_mode = int(uniform_Update_scenario_var_data[13]);
  repop_CA = uniform_Update_scenario_var_data[14];
  repop_BG = uniform_Update_scenario_var_data[15];
  video_satur = uniform_Update_scenario_var_data[16];
  video_value = uniform_Update_scenario_var_data[17];
  photoWeight = uniform_Update_scenario_var_data[18];
  photo_satur = uniform_Update_scenario_var_data[19];
  photo_value = uniform_Update_scenario_var_data[20];
  photo_gamma = uniform_Update_scenario_var_data[21];
  photo_threshold = uniform_Update_scenario_var_data[22];
  mask_scale = uniform_Update_scenario_var_data[23];
  photo_contrast = uniform_Update_scenario_var_data[24];
  mask_contrast = uniform_Update_scenario_var_data[25];
  CAParams1 = uniform_Update_scenario_var_data[26];
  CAParams2 = uniform_Update_scenario_var_data[27];
  CAParams3 = uniform_Update_scenario_var_data[28];
  CAParams4 = uniform_Update_scenario_var_data[29];
  CAParams5 = uniform_Update_scenario_var_data[30];
  CAParams6 = uniform_Update_scenario_var_data[31];
  CAParams7 = uniform_Update_scenario_var_data[32];
  CAParams8 = uniform_Update_scenario_var_data[33];
  CAstep = int(uniform_Update_scenario_var_data[34]);
  CAcolorSpread = (uniform_Update_scenario_var_data[35] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[36] > 0 ? true : false);
  invertCamera = (uniform_Update_scenario_var_data[37] > 0 ? true : false);
  photo_scale = uniform_Update_scenario_var_data[38];
  cameraCumul = int(uniform_Update_scenario_var_data[39]);
  camera_BG_subtr = (uniform_Update_scenario_var_data[40] > 0 ? true : false);
  cameraGamma = uniform_Update_scenario_var_data[41];
  camera_gamma = uniform_Update_scenario_var_data[42];
  camera_contrast = uniform_Update_scenario_var_data[43];
  cameraThreshold = uniform_Update_scenario_var_data[44];
  cameraWeight = uniform_Update_scenario_var_data[45];
  cameraSobel = uniform_Update_scenario_var_data[46];
