...
void main() {
  ...
  video_value = uniform_Update_scenario_var_data[31];
  photoWeight = uniform_Update_scenario_var_data[32];
  ...
  photo_rot = uniform_Update_scenario_var_data[37];
  photo_transl_x = uniform_Update_scenario_var_data[38];
  photo_transl_y = uniform_Update_scenario_var_data[39];
  mask_scale = uniform_Update_scenario_var_data[40];
  CAParams1 = uniform_Update_scenario_var_data[41];
  CAParams2 = uniform_Update_scenario_var_data[42];
  CAParams3 = uniform_Update_scenario_var_data[43];
  CAParams4 = uniform_Update_scenario_var_data[44];
  CAParams5 = uniform_Update_scenario_var_data[45];
  CAParams6 = uniform_Update_scenario_var_data[46];
  CAParams7 = uniform_Update_scenario_var_data[47];
  CAParams8 = uniform_Update_scenario_var_data[48];
  CAstep = int(uniform_Update_scenario_var_data[49]);
  CAcolorSpread = (uniform_Update_scenario_var_data[50] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[51] > 0 ? true : false);
  invertCamera = (uniform_Update_scenario_var_data[52] > 0 ? true : false);
  photo_scale = uniform_Update_scenario_var_data[53];
  cameraCumul = int(uniform_Update_scenario_var_data[54]);
