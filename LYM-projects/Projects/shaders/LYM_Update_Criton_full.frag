...
bool	  freeze;
float	 fft_scale;
uniform float uniform_Update_scenario_var_data[56];
...
void main() {
  ...
  currentDrawingTrack = int(uniform_Update_scenario_var_data[3]);
  currentVideoTrack = int(uniform_Update_scenario_var_data[4]);
  currentPhotoTrack = int(uniform_Update_scenario_var_data[5]);
  path_replay_trackNo_1 = int(uniform_Update_scenario_var_data[6]);
  path_replay_trackNo_2 = int(uniform_Update_scenario_var_data[7]);
  path_replay_trackNo_3 = int(uniform_Update_scenario_var_data[8]);
  noiseScale = uniform_Update_scenario_var_data[9];
  noiseType = int(uniform_Update_scenario_var_data[10]);
  noiseLineScale = uniform_Update_scenario_var_data[11];
  noiseAngleScale = uniform_Update_scenario_var_data[12];
  noiseCenterX = uniform_Update_scenario_var_data[13];
  noiseCenterY = uniform_Update_scenario_var_data[14];
  pixel_acc = uniform_Update_scenario_var_data[15];
  pixel_acc_shiftX = uniform_Update_scenario_var_data[16];
  pixel_acc_shiftY = uniform_Update_scenario_var_data[17];
  pixel_radius = uniform_Update_scenario_var_data[18];
  pixel_mode = int(uniform_Update_scenario_var_data[19]);
  repop_CA = uniform_Update_scenario_var_data[20];
  repop_BG = uniform_Update_scenario_var_data[21];
  cameraGamma = uniform_Update_scenario_var_data[22];
  activeClipArts = int(uniform_Update_scenario_var_data[23]);
  cameraThreshold = uniform_Update_scenario_var_data[24];
  cameraWeight = uniform_Update_scenario_var_data[25];
  cameraSobel = uniform_Update_scenario_var_data[26];
  ...
  video_hue = uniform_Update_scenario_var_data[30];
  video_satur = uniform_Update_scenario_var_data[31];
  video_satur_pulse = uniform_Update_scenario_var_data[32];
  video_value = uniform_Update_scenario_var_data[33];
  photoWeight = uniform_Update_scenario_var_data[34];
  photo_hue = uniform_Update_scenario_var_data[35];
  photo_satur = uniform_Update_scenario_var_data[36];
  photo_satur_pulse = uniform_Update_scenario_var_data[37];
  photo_value = uniform_Update_scenario_var_data[38];
  photo_value_pulse = uniform_Update_scenario_var_data[39];
  photo_scale = uniform_Update_scenario_var_data[40];
  photo_contrast = uniform_Update_scenario_var_data[41];
  mask_contrast = uniform_Update_scenario_var_data[42];
  CAParams1 = uniform_Update_scenario_var_data[43];
  CAParams2 = uniform_Update_scenario_var_data[44];
  CAParams3 = uniform_Update_scenario_var_data[45];
  CAParams4 = uniform_Update_scenario_var_data[46];
  CAParams5 = uniform_Update_scenario_var_data[47];
  CAParams6 = uniform_Update_scenario_var_data[48];
  CAParams7 = uniform_Update_scenario_var_data[49];
  CAParams8 = uniform_Update_scenario_var_data[50];
  cameraCumul = int(uniform_Update_scenario_var_data[51]);
  CAstep = int(uniform_Update_scenario_var_data[52]);
  CAcolorSpread = (uniform_Update_scenario_var_data[53] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[54] > 0 ? true : false);
  fft_scale = uniform_Update_scenario_var_data[55];
