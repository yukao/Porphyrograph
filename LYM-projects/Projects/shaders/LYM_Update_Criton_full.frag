...
bool      invertMovie;
int       cameraCumul;
uniform vec4 uniform_Update_fs_4fv_path_replay_trackNo_3_CAdecay_pulse_invertMovie_cameraCumul;
...
float     fft_scale;
uniform vec4 uniform_Update_fs_4fv_photo_scale_mask_contrast_photo_contrast_fft_scale;
...
void main() {
  ...
  path_replay_trackNo_3 = int(uniform_Update_fs_4fv_path_replay_trackNo_3_CAdecay_pulse_invertMovie_cameraCumul[0]);
  CAdecay_pulse = uniform_Update_fs_4fv_path_replay_trackNo_3_CAdecay_pulse_invertMovie_cameraCumul[1];
  invertMovie = (uniform_Update_fs_4fv_path_replay_trackNo_3_CAdecay_pulse_invertMovie_cameraCumul[2] > 0 ? true : false);
  cameraCumul = int(uniform_Update_fs_4fv_path_replay_trackNo_3_CAdecay_pulse_invertMovie_cameraCumul[3]);
  ...
  photo_scale = uniform_Update_fs_4fv_photo_scale_mask_contrast_photo_contrast_fft_scale[0];
  mask_contrast = uniform_Update_fs_4fv_photo_scale_mask_contrast_photo_contrast_fft_scale[1];
  photo_contrast = uniform_Update_fs_4fv_photo_scale_mask_contrast_photo_contrast_fft_scale[2];
  fft_scale = uniform_Update_fs_4fv_photo_scale_mask_contrast_photo_contrast_fft_scale[3];
