...
float	 noiseCenterY;
uniform float uniform_Update_scenario_var_data[67];
...
void main() {
  ...
  photo_satur = uniform_Update_scenario_var_data[32];
  photo_value = uniform_Update_scenario_var_data[33];
  photo_gamma = uniform_Update_scenario_var_data[34];
  photo_threshold = uniform_Update_scenario_var_data[35];
  photoWeight = uniform_Update_scenario_var_data[36];
  photo_scale = uniform_Update_scenario_var_data[37];
  mask_scale = uniform_Update_scenario_var_data[38];
  CAParams1 = uniform_Update_scenario_var_data[39];
  CAParams2 = uniform_Update_scenario_var_data[40];
  CAParams3 = uniform_Update_scenario_var_data[41];
  CAParams4 = uniform_Update_scenario_var_data[42];
  CAParams5 = uniform_Update_scenario_var_data[43];
  CAParams6 = uniform_Update_scenario_var_data[44];
  CAParams7 = uniform_Update_scenario_var_data[45];
  CAParams8 = uniform_Update_scenario_var_data[46];
  cameraCumul = int(uniform_Update_scenario_var_data[47]);
  CAstep = int(uniform_Update_scenario_var_data[48]);
  CAcolorSpread = (uniform_Update_scenario_var_data[49] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[50] > 0 ? true : false);
  camera_BG_subtr = (uniform_Update_scenario_var_data[51] > 0 ? true : false);
  BG_CA_repop_density = int(uniform_Update_scenario_var_data[52]);
  cameraGamma = uniform_Update_scenario_var_data[53];
  camera_gamma = uniform_Update_scenario_var_data[54];
  cameraThreshold = uniform_Update_scenario_var_data[55];
  cameraWeight = uniform_Update_scenario_var_data[56];
  cameraSobel = uniform_Update_scenario_var_data[57];
  video_gamma = uniform_Update_scenario_var_data[58];
  video_threshold = uniform_Update_scenario_var_data[59];
  photo_contrast = uniform_Update_scenario_var_data[60];
  mask_contrast = uniform_Update_scenario_var_data[61];
  noiseType = int(uniform_Update_scenario_var_data[62]);
  noiseLineScale = uniform_Update_scenario_var_data[63];
  noiseAngleScale = uniform_Update_scenario_var_data[64];
  noiseCenterX = uniform_Update_scenario_var_data[65];
  noiseCenterY = uniform_Update_scenario_var_data[66];
 ...
 // cursor type (+1 for stylus and -1 for rubber)
  ...
  cameraCoord = vec2((1 - decalCoordsPOT.x), (1 - decalCoordsPOT.y) )
