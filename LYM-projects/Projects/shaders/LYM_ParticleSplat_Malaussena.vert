...
uniform vec3 uniform_ParticleSplat_vp_3fv_trackReplay_xy_height;
...
void main()
{
	...
	if( uniform_ParticleSplat_vp_3fv_trackReplay_xy_height.x >= 0
		&& uniform_ParticleSplat_vp_3fv_trackReplay_xy_height.y >= 0 ) {
		VertexOut.replayTrackLocation = (vp_projMatrix * vp_viewMatrix *  vp_modelMatrix 
			* vec4(uniform_ParticleSplat_vp_3fv_trackReplay_xy_height.x, 
				uniform_ParticleSplat_vp_3fv_trackReplay_xy_height.z
				- uniform_ParticleSplat_vp_3fv_trackReplay_xy_height.y, 0, 1)).xy;
	}
	else {
