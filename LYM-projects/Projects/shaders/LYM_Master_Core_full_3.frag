...
void main() {
  ...
  master_scale = uniform_Master_scenario_var_data[9];
  master_scale_pulse = uniform_Master_scenario_var_data[10];
  master_scale_ratio = uniform_Master_scenario_var_data[11];
  master_offsetX = uniform_Master_scenario_var_data[12];
  master_offsetY = uniform_Master_scenario_var_data[13];
