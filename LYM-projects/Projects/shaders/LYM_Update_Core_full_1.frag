...
void main() {
  ...
  pixel_image_acceleration = int(uniform_Update_scenario_var_data[42]);
  cameraGamma = uniform_Update_scenario_var_data[43];
  camera_gamma = uniform_Update_scenario_var_data[44];
  cameraThreshold = uniform_Update_scenario_var_data[45];
  cameraWeight = uniform_Update_scenario_var_data[46];
  cameraSobel = uniform_Update_scenario_var_data[47];
  movieWeight = uniform_Update_scenario_var_data[48];
  movieSobel = uniform_Update_scenario_var_data[49];
  invertMovie = (uniform_Update_scenario_var_data[50] > 0 ? true : false);
  invertCamera = (uniform_Update_scenario_var_data[51] > 0 ? true : false);
  invertPhoto = (uniform_Update_scenario_var_data[52] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[53];
  video_value = uniform_Update_scenario_var_data[54];
  movie_gamma = uniform_Update_scenario_var_data[55];
  movie_threshold = uniform_Update_scenario_var_data[56];
  video_gamma = uniform_Update_scenario_var_data[57];
  video_threshold = uniform_Update_scenario_var_data[58];
  video_contrast = uniform_Update_scenario_var_data[59];
  photoWeight = uniform_Update_scenario_var_data[60];
  photo_satur = uniform_Update_scenario_var_data[61];
  photo_value = uniform_Update_scenario_var_data[62];
  photo_gamma = uniform_Update_scenario_var_data[63];
  photo_threshold = uniform_Update_scenario_var_data[64];
  photoSobel = uniform_Update_scenario_var_data[65];
  photo_scaleX = uniform_Update_scenario_var_data[66];
  photo_scaleY = uniform_Update_scenario_var_data[67];
  photo_rot = uniform_Update_scenario_var_data[68];
  photo_transl_x = uniform_Update_scenario_var_data[69];
  photo_transl_y = uniform_Update_scenario_var_data[70];
  mask_scale = uniform_Update_scenario_var_data[71];
  photo_contrast = uniform_Update_scenario_var_data[72];
  photo_equalization = uniform_Update_scenario_var_data[73];
  mask_contrast = uniform_Update_scenario_var_data[74];
