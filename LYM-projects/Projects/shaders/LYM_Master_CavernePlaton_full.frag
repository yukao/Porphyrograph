...
uniform vec3 uniform_Master_fs_3fv_master_mask_scale_master_mask_offsetX_master_mask_offsetY;
...
void main() {
  ...
  master_mask_scale = uniform_Master_fs_3fv_master_mask_scale_master_mask_offsetX_master_mask_offsetY[0];
  master_mask_offsetX = uniform_Master_fs_3fv_master_mask_scale_master_mask_offsetX_master_mask_offsetY[1];
  master_mask_offsetY = uniform_Master_fs_3fv_master_mask_scale_master_mask_offsetX_master_mask_offsetY[2];
