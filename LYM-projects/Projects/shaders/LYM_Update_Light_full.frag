...
float	 video_hue;
float	 photo_hue;
uniform float uniform_Update_scenario_var_data[65];
...
void main() {
  ...
  noiseScale = uniform_Update_scenario_var_data[12];
  noiseType = int(uniform_Update_scenario_var_data[13]);
  noiseLineScale = uniform_Update_scenario_var_data[14];
  noiseAngleScale = uniform_Update_scenario_var_data[15];
  noiseCenterX = uniform_Update_scenario_var_data[16];
  noiseCenterY = uniform_Update_scenario_var_data[17];
  pixel_acc = uniform_Update_scenario_var_data[18];
  pixel_acc_shiftX = uniform_Update_scenario_var_data[19];
  pixel_acc_shiftY = uniform_Update_scenario_var_data[20];
  pixel_radius = uniform_Update_scenario_var_data[21];
  pixel_mode = int(uniform_Update_scenario_var_data[22]);
  repop_CA = uniform_Update_scenario_var_data[23];
  repop_BG = uniform_Update_scenario_var_data[24];
  repop_density = int(uniform_Update_scenario_var_data[25]);
  ...
  invertCamera = (uniform_Update_scenario_var_data[32] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[33];
  video_satur_pulse = uniform_Update_scenario_var_data[34];
  video_value = uniform_Update_scenario_var_data[35];
  video_gamma = uniform_Update_scenario_var_data[36];
  video_threshold = uniform_Update_scenario_var_data[37];
  photoWeight = uniform_Update_scenario_var_data[38];
  photo_satur = uniform_Update_scenario_var_data[39];
  photo_satur_pulse = uniform_Update_scenario_var_data[40];
  photo_value = uniform_Update_scenario_var_data[41];
  photo_value_pulse = uniform_Update_scenario_var_data[42];
  photo_gamma = uniform_Update_scenario_var_data[43];
  photo_gamma_pulse = uniform_Update_scenario_var_data[44];
  photo_threshold = uniform_Update_scenario_var_data[45];
  photo_scale = uniform_Update_scenario_var_data[46];
  mask_scale = uniform_Update_scenario_var_data[47];
  photo_contrast = uniform_Update_scenario_var_data[48];
  mask_contrast = uniform_Update_scenario_var_data[49];
  CAParams1 = uniform_Update_scenario_var_data[50];
  CAParams2 = uniform_Update_scenario_var_data[51];
  CAParams3 = uniform_Update_scenario_var_data[52];
  CAParams4 = uniform_Update_scenario_var_data[53];
  CAParams5 = uniform_Update_scenario_var_data[54];
  CAParams6 = uniform_Update_scenario_var_data[55];
  CAParams7 = uniform_Update_scenario_var_data[56];
  CAParams8 = uniform_Update_scenario_var_data[57];
  cameraCumul = int(uniform_Update_scenario_var_data[58]);
  CAstep = int(uniform_Update_scenario_var_data[59]);
  CAcolorSpread = (uniform_Update_scenario_var_data[60] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[61] > 0 ? true : false);
  video_white = uniform_Update_scenario_var_data[62];
  video_hue = uniform_Update_scenario_var_data[63];
  photo_hue = uniform_Update_scenario_var_data[64];
