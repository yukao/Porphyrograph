...
float	 photo_hue;
#define var_ContAct_screenLayout
int		ContAct_screenLayout;
...
void main() {
  ...
  activeClipArts = int(uniform_Update_scenario_var_data[34]);
  movieWeight = uniform_Update_scenario_var_data[35];
  movieSobel = uniform_Update_scenario_var_data[36];
  invertMovie = (uniform_Update_scenario_var_data[37] > 0 ? true : false);
  invertPhoto = (uniform_Update_scenario_var_data[38] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[39];
  video_satur_pulse = uniform_Update_scenario_var_data[40];
  video_value = uniform_Update_scenario_var_data[41];
  video_gamma = uniform_Update_scenario_var_data[42];
  ...
  photoWeight = uniform_Update_scenario_var_data[46];
  photo_satur = uniform_Update_scenario_var_data[47];
  photo_satur_pulse = uniform_Update_scenario_var_data[48];
  photo_value = uniform_Update_scenario_var_data[49];
  photo_value_pulse = uniform_Update_scenario_var_data[50];
  photo_gamma = uniform_Update_scenario_var_data[51];
  photo_gamma_pulse = uniform_Update_scenario_var_data[52];
  photo_threshold = uniform_Update_scenario_var_data[53];
  photoSobel = uniform_Update_scenario_var_data[54];
  ...
  photo_contrast_pulse = uniform_Update_scenario_var_data[58];
  mask_contrast = uniform_Update_scenario_var_data[59];
  CAParams1 = uniform_Update_scenario_var_data[60];
  CAParams2 = uniform_Update_scenario_var_data[61];
  CAParams3 = uniform_Update_scenario_var_data[62];
  CAParams4 = uniform_Update_scenario_var_data[63];
  CAParams5 = uniform_Update_scenario_var_data[64];
  CAParams6 = uniform_Update_scenario_var_data[65];
  CAParams7 = uniform_Update_scenario_var_data[66];
  CAParams8 = uniform_Update_scenario_var_data[67];
  cameraCumul = int(uniform_Update_scenario_var_data[68]);
  CAstep = int(uniform_Update_scenario_var_data[69]);
  CAcolorSpread = (uniform_Update_scenario_var_data[70] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[71] > 0 ? true : false);
  video_white = uniform_Update_scenario_var_data[72];
  video_hue = uniform_Update_scenario_var_data[73];
  photo_hue = uniform_Update_scenario_var_data[74];
  ContAct_screenLayout = int(uniform_Update_scenario_var_data[75]);
