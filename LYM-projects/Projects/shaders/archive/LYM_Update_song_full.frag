...
float     repop_CA;
int       CAType;
uniform vec4 uniform_Update_fs_4fv_pixel_acc_center_1_repop_BG_repop_CA_CAType;
int       CASubType;
int       currentDrawingTrack;
int       currentVideoTrack;
int       currentPhotoTrack;
uniform vec4 uniform_Update_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack;
int       path_replay_trackNo_1;
int       path_replay_trackNo_2;
int       path_replay_trackNo_3;
int       path_replay_trackNo_4;
uniform vec4 uniform_Update_fs_4fv_path_replay_trackNo_1_path_replay_trackNo_2_path_replay_trackNo_3_path_replay_trackNo_4;
int       path_replay_trackNo_5;
int       path_replay_trackNo_6;
int       path_replay_trackNo_7;
bool      part_path_follow_0;
uniform vec4 uniform_Update_fs_4fv_path_replay_trackNo_5_path_replay_trackNo_6_path_replay_trackNo_7_part_path_follow_0;
bool      part_path_follow_1;
bool      part_path_follow_2;
bool      part_path_follow_3;
bool      part_path_follow_4;
uniform vec4 uniform_Update_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_follow_4;
bool      part_path_follow_5;
bool      part_path_follow_6;
bool      part_path_follow_7;
bool      part_path_repulse_0;
uniform vec4 uniform_Update_fs_4fv_part_path_follow_5_part_path_follow_6_part_path_follow_7_part_path_repulse_0;
bool      part_path_repulse_1;
bool      part_path_repulse_2;
bool      part_path_repulse_3;
bool      part_path_repulse_4;
uniform vec4 uniform_Update_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_part_path_repulse_4;
bool      part_path_repulse_5;
bool      part_path_repulse_6;
bool      part_path_repulse_7;
float     CAdecay_pulse;
uniform vec4 uniform_Update_fs_4fv_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7_CAdecay_pulse;
bool      invertMovie;
int       cameraCumul;
...
float     cameraSobel;
float     movieSobel;
uniform vec4 uniform_Update_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel;
bool      BGSubtr;
int       CAstep;
bool      CAcolorSpread;
bool      freeze;
uniform vec4 uniform_Update_fs_4fv_BGSubtr_CAstep_CAcolorSpread_freeze;
int       part_initialization;
bool      partMove_target;
bool      partMove_rand;
int       partExit_mode;
uniform vec4 uniform_Update_fs_4fv_part_initialization_partMove_target_partMove_rand_partExit_mode;
int       partStroke_mode;
int       partColor_mode;
float     part_damp_targtRad;
float     part_timeToTargt;
uniform vec4 uniform_Update_fs_4fv_partStroke_mode_partColor_mode_part_damp_targtRad_part_timeToTargt;
float     part_field_weight;
float     partRepopRadius;
int       particle_type;
uniform vec3 uniform_Update_fs_3fv_part_field_weight_partRepopRadius_particle_type;
...
void particle_out( void ) {
  ...
  if( index == 0 ) {
    ...
    if( repop_path > 0
        && int(frameNo * randomValue.w ) % int(15000 *(1-repop_path)) == int((randomValue.x * 5000.0
        ...
        if( indPath >= 0 && indPath < 4 
         ...
         /////////////////////////////////////////////////////////////////////
          ...
          out_position_speed_particle.xy += orth * 2 * (randomCA.w - 0.5) 
                  * uniform_Update_fs_4fv_paths03_RadiusX[indPath]; // thickness
         ...
         /////////////////////////////////////////////////////////////////////
          ...
          out_position_speed_particle.xy 
            = mix(pen_curr, pen_prev, randomCA.z ); // linear position
          out_position_speed_particle.xy += orth * 2 * (randomCA.w - 0.5) 
                  * uniform_Update_fs_4fv_paths47_RadiusX[indPath - 4]; // thickness
          out_position_speed_particle.zw = (randomValue.xy - vec2(0.5)) * vec2(0.1); // speed
          out_color_radius_particle 
...
void main() {
  ...
  pixel_acc_center_1 = uniform_Update_fs_4fv_pixel_acc_center_1_repop_BG_repop_CA_CAType[0];
  repop_BG = uniform_Update_fs_4fv_pixel_acc_center_1_repop_BG_repop_CA_CAType[1];
  repop_CA = uniform_Update_fs_4fv_pixel_acc_center_1_repop_BG_repop_CA_CAType[2];
  CAType = int(uniform_Update_fs_4fv_pixel_acc_center_1_repop_BG_repop_CA_CAType[3]);
  CASubType = int(uniform_Update_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[0]);
  currentDrawingTrack = int(uniform_Update_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[1]);
  currentVideoTrack = int(uniform_Update_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[2]);
  currentPhotoTrack = int(uniform_Update_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[3]);
  path_replay_trackNo_1 = int(uniform_Update_fs_4fv_path_replay_trackNo_1_path_replay_trackNo_2_path_replay_trackNo_3_path_replay_trackNo_4[0]);
  path_replay_trackNo_2 = int(uniform_Update_fs_4fv_path_replay_trackNo_1_path_replay_trackNo_2_path_replay_trackNo_3_path_replay_trackNo_4[1]);
  path_replay_trackNo_3 = int(uniform_Update_fs_4fv_path_replay_trackNo_1_path_replay_trackNo_2_path_replay_trackNo_3_path_replay_trackNo_4[2]);
  path_replay_trackNo_4 = int(uniform_Update_fs_4fv_path_replay_trackNo_1_path_replay_trackNo_2_path_replay_trackNo_3_path_replay_trackNo_4[3]);
  path_replay_trackNo_5 = int(uniform_Update_fs_4fv_path_replay_trackNo_5_path_replay_trackNo_6_path_replay_trackNo_7_part_path_follow_0[0]);
  path_replay_trackNo_6 = int(uniform_Update_fs_4fv_path_replay_trackNo_5_path_replay_trackNo_6_path_replay_trackNo_7_part_path_follow_0[1]);
  path_replay_trackNo_7 = int(uniform_Update_fs_4fv_path_replay_trackNo_5_path_replay_trackNo_6_path_replay_trackNo_7_part_path_follow_0[2]);
  part_path_follow_0 = (uniform_Update_fs_4fv_path_replay_trackNo_5_path_replay_trackNo_6_path_replay_trackNo_7_part_path_follow_0[3] > 0 ? true : false);
  part_path_follow_1 = (uniform_Update_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_follow_4[0] > 0 ? true : false);
  part_path_follow_2 = (uniform_Update_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_follow_4[1] > 0 ? true : false);
  part_path_follow_3 = (uniform_Update_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_follow_4[2] > 0 ? true : false);
  part_path_follow_4 = (uniform_Update_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_follow_4[3] > 0 ? true : false);
  part_path_follow_5 = (uniform_Update_fs_4fv_part_path_follow_5_part_path_follow_6_part_path_follow_7_part_path_repulse_0[0] > 0 ? true : false);
  part_path_follow_6 = (uniform_Update_fs_4fv_part_path_follow_5_part_path_follow_6_part_path_follow_7_part_path_repulse_0[1] > 0 ? true : false);
  part_path_follow_7 = (uniform_Update_fs_4fv_part_path_follow_5_part_path_follow_6_part_path_follow_7_part_path_repulse_0[2] > 0 ? true : false);
  part_path_repulse_0 = (uniform_Update_fs_4fv_part_path_follow_5_part_path_follow_6_part_path_follow_7_part_path_repulse_0[3] > 0 ? true : false);
  part_path_repulse_1 = (uniform_Update_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_part_path_repulse_4[0] > 0 ? true : false);
  part_path_repulse_2 = (uniform_Update_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_part_path_repulse_4[1] > 0 ? true : false);
  part_path_repulse_3 = (uniform_Update_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_part_path_repulse_4[2] > 0 ? true : false);
  part_path_repulse_4 = (uniform_Update_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_part_path_repulse_4[3] > 0 ? true : false);
  part_path_repulse_5 = (uniform_Update_fs_4fv_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7_CAdecay_pulse[0] > 0 ? true : false);
  part_path_repulse_6 = (uniform_Update_fs_4fv_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7_CAdecay_pulse[1] > 0 ? true : false);
  part_path_repulse_7 = (uniform_Update_fs_4fv_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7_CAdecay_pulse[2] > 0 ? true : false);
  CAdecay_pulse = uniform_Update_fs_4fv_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7_CAdecay_pulse[3];
  ...
  cameraWeight = uniform_Update_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[0];
  movieWeight = uniform_Update_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[1];
  cameraSobel = uniform_Update_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[2];
  movieSobel = uniform_Update_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[3];
  BGSubtr = (uniform_Update_fs_4fv_BGSubtr_CAstep_CAcolorSpread_freeze[0] > 0 ? true : false);
  CAstep = int(uniform_Update_fs_4fv_BGSubtr_CAstep_CAcolorSpread_freeze[1]);
  CAcolorSpread = (uniform_Update_fs_4fv_BGSubtr_CAstep_CAcolorSpread_freeze[2] > 0 ? true : false);
  freeze = (uniform_Update_fs_4fv_BGSubtr_CAstep_CAcolorSpread_freeze[3] > 0 ? true : false);
  part_initialization = int(uniform_Update_fs_4fv_part_initialization_partMove_target_partMove_rand_partExit_mode[0]);
  partMove_target = (uniform_Update_fs_4fv_part_initialization_partMove_target_partMove_rand_partExit_mode[1] > 0 ? true : false);
  partMove_rand = (uniform_Update_fs_4fv_part_initialization_partMove_target_partMove_rand_partExit_mode[2] > 0 ? true : false);
  partExit_mode = int(uniform_Update_fs_4fv_part_initialization_partMove_target_partMove_rand_partExit_mode[3]);
  partStroke_mode = int(uniform_Update_fs_4fv_partStroke_mode_partColor_mode_part_damp_targtRad_part_timeToTargt[0]);
  partColor_mode = int(uniform_Update_fs_4fv_partStroke_mode_partColor_mode_part_damp_targtRad_part_timeToTargt[1]);
  part_damp_targtRad = uniform_Update_fs_4fv_partStroke_mode_partColor_mode_part_damp_targtRad_part_timeToTargt[2];
  part_timeToTargt = uniform_Update_fs_4fv_partStroke_mode_partColor_mode_part_damp_targtRad_part_timeToTargt[3];
  part_field_weight = uniform_Update_fs_3fv_part_field_weight_partRepopRadius_particle_type[0];
  partRepopRadius = uniform_Update_fs_3fv_part_field_weight_partRepopRadius_particle_type[1];
  particle_type = int(uniform_Update_fs_3fv_part_field_weight_partRepopRadius_particle_type[2]);
    ...
    for( int indPath = 0 ; indPath <= PG_NB_PATHS ; indPath++ ) {
      ...
      if( pathStroke > 0 ) {
        if(indPath < 4) {
            ...
            if(indPath == 0 
                && int(uniform_Update_fs_4fv_paths03_BrushID[indPath]) >= 1
                && decalCoords.x < width / 2) {
                brushSizeDivider = 10;
            }
#endif            
