...
void main() {
  ...
  camera_gamma = uniform_Update_scenario_var_data[35];
  activeClipArts = int(uniform_Update_scenario_var_data[36]);
  cameraThreshold = uniform_Update_scenario_var_data[37];
  cameraWeight = uniform_Update_scenario_var_data[38];
  cameraSobel = uniform_Update_scenario_var_data[39];
  ...
  invertPhoto = (uniform_Update_scenario_var_data[44] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[45];
  video_satur_pulse = uniform_Update_scenario_var_data[46];
  ...
  photoWeight = uniform_Update_scenario_var_data[52];
  photo_satur = uniform_Update_scenario_var_data[53];
  photo_satur_pulse = uniform_Update_scenario_var_data[54];
  photo_value = uniform_Update_scenario_var_data[55];
  photo_value_pulse = uniform_Update_scenario_var_data[56];
  photo_gamma = uniform_Update_scenario_var_data[57];
  photo_gamma_pulse = uniform_Update_scenario_var_data[58];
  photo_threshold = uniform_Update_scenario_var_data[59];
  photoSobel = uniform_Update_scenario_var_data[60];
  photo_scale = uniform_Update_scenario_var_data[61];
  photo_rot = uniform_Update_scenario_var_data[62];
  photo_transl_x = uniform_Update_scenario_var_data[63];
  photo_transl_y = uniform_Update_scenario_var_data[64];
  mask_scale = uniform_Update_scenario_var_data[65];
  photo_contrast = uniform_Update_scenario_var_data[66];
  mask_contrast = uniform_Update_scenario_var_data[67];
  CAParams1 = uniform_Update_scenario_var_data[68];
  CAParams2 = uniform_Update_scenario_var_data[69];
  CAParams3 = uniform_Update_scenario_var_data[70];
  CAParams4 = uniform_Update_scenario_var_data[71];
  CAParams5 = uniform_Update_scenario_var_data[72];
  CAParams6 = uniform_Update_scenario_var_data[73];
  CAParams7 = uniform_Update_scenario_var_data[74];
  CAParams8 = uniform_Update_scenario_var_data[75];
  cameraCumul = int(uniform_Update_scenario_var_data[76]);
  CAstep = int(uniform_Update_scenario_var_data[77]);
