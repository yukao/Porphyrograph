...
uniform float uniform_Update_scenario_var_data[44];
...
void main() {
  ...
  mask_contrast = uniform_Update_scenario_var_data[30];
  CAParams1 = uniform_Update_scenario_var_data[31];
  CAParams2 = uniform_Update_scenario_var_data[32];
  CAParams3 = uniform_Update_scenario_var_data[33];
  CAParams4 = uniform_Update_scenario_var_data[34];
  CAParams5 = uniform_Update_scenario_var_data[35];
  CAParams6 = uniform_Update_scenario_var_data[36];
  CAParams7 = uniform_Update_scenario_var_data[37];
  CAParams8 = uniform_Update_scenario_var_data[38];
  CAstep = int(uniform_Update_scenario_var_data[39]);
  CAcolorSpread = (uniform_Update_scenario_var_data[40] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[41] > 0 ? true : false);
  video_white = uniform_Update_scenario_var_data[42];
  Song_CA_color_mode = (uniform_Update_scenario_var_data[43] > 0 ? true : false);
