...
#include_initializations
  ...
  if (currentMaskTrack == 0) {
    trackMasterWeight_0 = 0; 
    maskGrey = graylevel(track0_color.rgb); 
  }
#if PG_NB_TRACKS >= 2
  else if (currentMaskTrack == 1) {
    trackMasterWeight_1 = 0; 
    maskGrey = graylevel(track1_color.rgb);
  }
#endif
#if PG_NB_TRACKS >= 3
  else if (currentMaskTrack == 2) {
    trackMasterWeight_2 = 0; 
    maskGrey = graylevel(track2_color.rgb);
  }
#endif
#if PG_NB_TRACKS >= 4
  else if (currentMaskTrack == 3) {
    trackMasterWeight_3 = 0; 
    maskGrey = graylevel(track3_color.rgb);
  }
#endif
#endif
...
#endif
#if PG_NB_TRACKS >= 2 && defined(var_trackMasterWeight_1)
