...
uniform vec4 uniform_Update_fs_4fv_CAType_CASubType_currentDrawingTrack_currentVideoTrack;
int       currentPhotoTrack;
bool      path_replay_1;
bool      path_replay_2;
bool      path_replay_3;
uniform vec4 uniform_Update_fs_4fv_currentPhotoTrack_path_replay_1_path_replay_2_path_replay_3;
bool      path_replay_4;
bool      path_replay_5;
bool      path_replay_6;
bool      path_replay_7;
uniform vec4 uniform_Update_fs_4fv_path_replay_4_path_replay_5_path_replay_6_path_replay_7;
bool      part_path_follow_0;
bool      part_path_follow_1;
bool      part_path_follow_2;
bool      part_path_follow_3;
uniform vec4 uniform_Update_fs_4fv_part_path_follow_0_part_path_follow_1_part_path_follow_2_part_path_follow_3;
bool      part_path_follow_4;
bool      part_path_follow_5;
bool      part_path_follow_6;
bool      part_path_follow_7;
uniform vec4 uniform_Update_fs_4fv_part_path_follow_4_part_path_follow_5_part_path_follow_6_part_path_follow_7;
bool      part_path_repulse_0;
bool      part_path_repulse_1;
bool      part_path_repulse_2;
bool      part_path_repulse_3;
uniform vec4 uniform_Update_fs_4fv_part_path_repulse_0_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3;
bool      part_path_repulse_4;
bool      part_path_repulse_5;
bool      part_path_repulse_6;
bool      part_path_repulse_7;
uniform vec4 uniform_Update_fs_4fv_part_path_repulse_4_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7;
float     CAdecay_pulse;
bool      invertMovie;
int       cameraCumul;
...
bool      partMove_rand;
uniform vec4 uniform_Update_fs_4fv_freeze_part_initialization_partMove_target_partMove_rand;
int       partExit_mode;
int       partStroke_mode;
int       partColor_mode;
...
const uint PARTREPOP_GRID = 1; // random repopulation according to a certain threshold
// from PARTREPOP_GRID + 1 to PARTREPOP_GRID + 2 PG_NB_PATHS
...
uniform vec3 uniform_Update_fs_3fv_clearAllLayers_clearCA_pixelRadius;
...
uniform vec2 uniform_Update_fs_2fv_part_acc_damp_factor;
  ...
  if( index == 0 ) {
    ...
    if(part_initialization >= 0) {
      ...
      // camera
          ...
          vec4 target_color = texture( fs_lookupTable9 , cameraWH - cameraCoord.xy );
          if(partMove_target) { // reaches a target in several steps
              out_target_position_color_radius_particle.xy
                    = texture( fs_lookupTable16 , decalCoords ).xy;
              out_target_position_color_radius_particle.z
    ...
    // const uint PARTREPOP_NONE = 0;
    // const uint PARTREPOP_GRID = 1; // random repopulation according to a certain threshold
    // from 0 to PG_NB_PATHS + PARTREPOP_GRID
    if( out_position_speed_particle.x == -10000) {
      ...
      if( int(frameNo * randomValue.w ) % int(765 *(1-repop_part)) == int((randomValue.x * 255.0
          + randomValue.y * 255.0 + randomValue.z * 255.0 ) *(1-repop_part)) ) {
        int indRepopChannel = int(uniform_Update_fs_4fv_W_H_repopChannel_targetFrameNo.z);
        if(indRepopChannel == PG_NB_PATHS + PARTREPOP_GRID) {
    ...
    if(partStroke_mode == PARTSTROKE_AGGREG) { // aggregation
      if(graylevel(flashToPartCumul) > 0.01)  {
      ...
      if(graylevel(flashToPartCumul) > 0.01)  {
          out_position_speed_particle.zw 
            -= graylevel(flashToPartCumul) * 0.1 * out_position_speed_particle.zw;
      }
    }
...
void main() {
  ...
  currentVideoTrack = int(uniform_Update_fs_4fv_CAType_CASubType_currentDrawingTrack_currentVideoTrack[3]);
  currentPhotoTrack = int(uniform_Update_fs_4fv_currentPhotoTrack_path_replay_1_path_replay_2_path_replay_3[0]);
  path_replay_1 = (uniform_Update_fs_4fv_currentPhotoTrack_path_replay_1_path_replay_2_path_replay_3[1] > 0 ? true : false);
  path_replay_2 = (uniform_Update_fs_4fv_currentPhotoTrack_path_replay_1_path_replay_2_path_replay_3[2] > 0 ? true : false);
  path_replay_3 = (uniform_Update_fs_4fv_currentPhotoTrack_path_replay_1_path_replay_2_path_replay_3[3] > 0 ? true : false);
  path_replay_4 = (uniform_Update_fs_4fv_path_replay_4_path_replay_5_path_replay_6_path_replay_7[0] > 0 ? true : false);
  path_replay_5 = (uniform_Update_fs_4fv_path_replay_4_path_replay_5_path_replay_6_path_replay_7[1] > 0 ? true : false);
  path_replay_6 = (uniform_Update_fs_4fv_path_replay_4_path_replay_5_path_replay_6_path_replay_7[2] > 0 ? true : false);
  path_replay_7 = (uniform_Update_fs_4fv_path_replay_4_path_replay_5_path_replay_6_path_replay_7[3] > 0 ? true : false);
  part_path_follow_0 = (uniform_Update_fs_4fv_part_path_follow_0_part_path_follow_1_part_path_follow_2_part_path_follow_3[0] > 0 ? true : false);
  part_path_follow_1 = (uniform_Update_fs_4fv_part_path_follow_0_part_path_follow_1_part_path_follow_2_part_path_follow_3[1] > 0 ? true : false);
  part_path_follow_2 = (uniform_Update_fs_4fv_part_path_follow_0_part_path_follow_1_part_path_follow_2_part_path_follow_3[2] > 0 ? true : false);
  part_path_follow_3 = (uniform_Update_fs_4fv_part_path_follow_0_part_path_follow_1_part_path_follow_2_part_path_follow_3[3] > 0 ? true : false);
  part_path_follow_4 = (uniform_Update_fs_4fv_part_path_follow_4_part_path_follow_5_part_path_follow_6_part_path_follow_7[0] > 0 ? true : false);
  part_path_follow_5 = (uniform_Update_fs_4fv_part_path_follow_4_part_path_follow_5_part_path_follow_6_part_path_follow_7[1] > 0 ? true : false);
  part_path_follow_6 = (uniform_Update_fs_4fv_part_path_follow_4_part_path_follow_5_part_path_follow_6_part_path_follow_7[2] > 0 ? true : false);
  part_path_follow_7 = (uniform_Update_fs_4fv_part_path_follow_4_part_path_follow_5_part_path_follow_6_part_path_follow_7[3] > 0 ? true : false);
  part_path_repulse_0 = (uniform_Update_fs_4fv_part_path_repulse_0_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3[0] > 0 ? true : false);
  part_path_repulse_1 = (uniform_Update_fs_4fv_part_path_repulse_0_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3[1] > 0 ? true : false);
  part_path_repulse_2 = (uniform_Update_fs_4fv_part_path_repulse_0_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3[2] > 0 ? true : false);
  part_path_repulse_3 = (uniform_Update_fs_4fv_part_path_repulse_0_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3[3] > 0 ? true : false);
  part_path_repulse_4 = (uniform_Update_fs_4fv_part_path_repulse_4_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7[0] > 0 ? true : false);
  part_path_repulse_5 = (uniform_Update_fs_4fv_part_path_repulse_4_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7[1] > 0 ? true : false);
  part_path_repulse_6 = (uniform_Update_fs_4fv_part_path_repulse_4_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7[2] > 0 ? true : false);
  part_path_repulse_7 = (uniform_Update_fs_4fv_part_path_repulse_4_part_path_repulse_5_part_path_repulse_6_part_path_repulse_7[3] > 0 ? true : false);
  ...
  cameraGamma = uniform_Update_fs_4fv_cameraGamma_cameraWeight_movieWeight_cameraSobel[0];
  ...
  partMove_rand = (uniform_Update_fs_4fv_freeze_part_initialization_partMove_target_partMove_rand[3] > 0 ? true : false);
  partExit_mode = int(uniform_Update_fs_4fv_partExit_mode_partStroke_mode_partColor_mode_part_damp_targtRad[0]);
  ...
  randomCA2 = texture( fs_lookupTable12 , vec3( vec2(1,1) - pixelTextureCoordinatesXY , 0.5 ) ).rgb;
  ...
  if(frameNo <= 10 || uniform_Update_fs_3fv_clearAllLayers_clearCA_pixelRadius.x > 0) {
    outColor0 = vec4(0);  // CA
...
#if PG_NB_TRACKS >= 2
  out_track_FBO[1] 
    = texture( fs_lookupTable6 , decalCoords );
#endif
#if PG_NB_TRACKS >= 3
  out_track_FBO[2] 
 ...
 */  cameraCoord = vec2(1 - decalCoordsPOT.x, (decalCoordsPOT.y) )
  ...
  /////////////////////////////////////
  // builds a path_replay vector so that it can be used in the for loop
  #if PG_NB_PATHS == 3 || PG_NB_PATHS == 7
  bvec3 path_replay03 = bvec3(path_replay_1,path_replay_2,path_replay_3);
  #endif
  #if PG_NB_PATHS == 7
  bvec4 path_replay47 = bvec4(path_replay_4,path_replay_5,path_replay_6,path_replay_7);
  #endif
    ...
    for( int indPath = 0 ; indPath <= PG_NB_PATHS ; indPath++ ) {
...
#if PG_NB_PATHS == 3 || PG_NB_PATHS == 7
      else if( indPath > 0 && indPath < 4 && path_replay03[indPath - 1] && currentDrawingTrack == indCurTrack ) {
        pathStroke = DRAWING_LINE;
      }
#endif
#if PG_NB_PATHS == 7
      else if( indPath >= 4 && path_replay47[indPath - 4] && currentDrawingTrack == indCurTrack ) {
        pathStroke = DRAWING_LINE;
      }
#endif
      ...
      if( pathStroke > 0 ) {
        if(indPath < 4) {
          ...
          += out_gray_drawing( uniform_Update_fs_4fv_paths03_x[indPath] , 
                ...
                pathStroke ) 
                * uniform_Update_fs_4fv_paths03_a[indPath];  // brush opacity is combined with color opacity
        }
        else {
          track_grayLevel[indCurTrack] 
          += out_gray_drawing( uniform_Update_fs_4fv_paths47_x[indPath - 4] , 
                ...
                pathStroke ) 
                * uniform_Update_fs_4fv_paths47_a[indPath - 4];  // brush opacity is combined with color opacity
        }
                ...
                += out_track_FBO[indCurTrack].rgb * clamp((1 - track_grayLevel[indCurTrack]),0,1)
                  + track_grayLevel[indCurTrack]
                    * vec3( uniform_Update_fs_4fv_paths03_r[indPath] , 
                            ...
                            uniform_Update_fs_4fv_paths03_b[indPath] );
            }
            else {
              out_track_FBO[indCurTrack].rgb 
                += out_track_FBO[indCurTrack].rgb * clamp((1 - track_grayLevel[indCurTrack]),0,1)
...
*/
    ...
    if( repop_CA > 0 ) {
      // if the pixel noise is equal to frame % 8500 the cell is repopulated with a pixel
      vec4 randomValue = texture( fs_lookupTable12 , vec3( decalCoordsPOT , 0.0 ) );
      if( int(frameNo * randomValue.w ) % int(765 *(1-repop_CA)) == int((randomValue.x * 255.0
          + randomValue.y * 255.0 + randomValue.z * 255.0 ) *(1-repop_CA)) ) {
        out4_CA.a = -1.0;
  ...
  if( repop_BG > 0 ) {
    // if the pixel noise is equal to frame % 8500 the cell is repopulated with a pixel
    vec4 randomValue = texture( fs_lookupTable12 , vec3( decalCoordsPOT , 0.5 ) );
    if( int(frameNo * randomValue.w ) % int(765 *(1-repop_BG)) == int((randomValue.x * 255.0
        + randomValue.y * 255.0 + randomValue.z * 255.0 ) *(1-repop_BG)) ) {
  ...
  //////////////////////////////////////////////
  // CA LAYER CLEAR
  if( uniform_Update_fs_3fv_clearAllLayers_clearCA_pixelRadius.y > 0 ) {
