...
void main() {
  invertAllLayers = (uniform_Master_scenario_var_data[0] > 0 ? true : false);
  cursorSize = int(uniform_Master_scenario_var_data[1]);
  master = uniform_Master_scenario_var_data[2];
  CAMasterWeight = uniform_Master_scenario_var_data[3];
  PartMasterWeight = uniform_Master_scenario_var_data[4];
  trackMasterWeight_0 = uniform_Master_scenario_var_data[5];
  trackMasterWeight_1 = uniform_Master_scenario_var_data[6];
  trackMasterWeight_2 = uniform_Master_scenario_var_data[7];
  trackMasterWeight_3 = uniform_Master_scenario_var_data[8];
  SecondMasterMixingWeight = uniform_Master_scenario_var_data[9];
  mute_second_screen = (uniform_Master_scenario_var_data[10] > 0 ? true : false);
