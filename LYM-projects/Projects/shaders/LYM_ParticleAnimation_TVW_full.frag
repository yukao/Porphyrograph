...
uniform vec4 uniform_ParticleAnimation_fs_4fv_part_path_follow_2_part_path_follow_3_part_path_repulse_0_part_path_repulse_1;
bool      part_path_repulse_2;
bool      part_path_repulse_3;
float     part_size;
float     part_acc;
uniform vec4 uniform_ParticleAnimation_fs_4fv_part_path_repulse_2_part_path_repulse_3_part_size_part_acc;
float     part_damp;
float     noiseScale;
...
void main() {
  ...
  part_path_follow_2 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_2_part_path_follow_3_part_path_repulse_0_part_path_repulse_1[0] > 0 ? true : false);
  part_path_follow_3 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_2_part_path_follow_3_part_path_repulse_0_part_path_repulse_1[1] > 0 ? true : false);
  part_path_repulse_0 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_2_part_path_follow_3_part_path_repulse_0_part_path_repulse_1[2] > 0 ? true : false);
  part_path_repulse_1 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_2_part_path_follow_3_part_path_repulse_0_part_path_repulse_1[3] > 0 ? true : false);
  part_path_repulse_2 = (uniform_ParticleAnimation_fs_4fv_part_path_repulse_2_part_path_repulse_3_part_size_part_acc[0] > 0 ? true : false);
  part_path_repulse_3 = (uniform_ParticleAnimation_fs_4fv_part_path_repulse_2_part_path_repulse_3_part_size_part_acc[1] > 0 ? true : false);
  part_size = uniform_ParticleAnimation_fs_4fv_part_path_repulse_2_part_path_repulse_3_part_size_part_acc[2];
  part_acc = uniform_ParticleAnimation_fs_4fv_part_path_repulse_2_part_path_repulse_3_part_size_part_acc[3];
