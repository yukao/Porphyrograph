...
float	 photo_hue;
uniform float uniform_Update_scenario_var_data[79];
...
void main() {
  ...
  path_replay_trackNo_8 = int(uniform_Update_scenario_var_data[15]);
  ...
  invertCamera = (uniform_Update_scenario_var_data[30] > 0 ? true : false);
  ...
  photo_gamma = uniform_Update_scenario_var_data[35];
  photo_threshold = uniform_Update_scenario_var_data[36];
  photoWeight = uniform_Update_scenario_var_data[37];
  photo_rot = uniform_Update_scenario_var_data[38];
  photo_transl_x = uniform_Update_scenario_var_data[39];
  photo_transl_y = uniform_Update_scenario_var_data[40];
  mask_scale = uniform_Update_scenario_var_data[41];
  CAParams1 = uniform_Update_scenario_var_data[42];
  CAParams2 = uniform_Update_scenario_var_data[43];
  CAParams3 = uniform_Update_scenario_var_data[44];
  CAParams4 = uniform_Update_scenario_var_data[45];
  CAParams5 = uniform_Update_scenario_var_data[46];
  CAParams6 = uniform_Update_scenario_var_data[47];
  CAParams7 = uniform_Update_scenario_var_data[48];
  CAParams8 = uniform_Update_scenario_var_data[49];
  cameraCumul = int(uniform_Update_scenario_var_data[50]);
  CAstep = int(uniform_Update_scenario_var_data[51]);
  CAcolorSpread = (uniform_Update_scenario_var_data[52] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[53] > 0 ? true : false);
  camera_BG_subtr = (uniform_Update_scenario_var_data[54] > 0 ? true : false);
  BG_CA_repop_density = int(uniform_Update_scenario_var_data[55]);
  BG_CA_repop_color_mode = int(uniform_Update_scenario_var_data[56]);
  video_white = uniform_Update_scenario_var_data[57];
  pixel_image_acceleration = int(uniform_Update_scenario_var_data[58]);
  cameraGamma = uniform_Update_scenario_var_data[59];
  camera_gamma = uniform_Update_scenario_var_data[60];
  cameraThreshold = uniform_Update_scenario_var_data[61];
  cameraWeight = uniform_Update_scenario_var_data[62];
  cameraSobel = uniform_Update_scenario_var_data[63];
  invertPhoto = (uniform_Update_scenario_var_data[64] > 0 ? true : false);
  movie_gamma = uniform_Update_scenario_var_data[65];
  movie_threshold = uniform_Update_scenario_var_data[66];
  video_gamma = uniform_Update_scenario_var_data[67];
  video_threshold = uniform_Update_scenario_var_data[68];
  video_contrast = uniform_Update_scenario_var_data[69];
  photoSobel = uniform_Update_scenario_var_data[70];
  photo_scaleX = uniform_Update_scenario_var_data[71];
  photo_scaleY = uniform_Update_scenario_var_data[72];
  photo_contrast = uniform_Update_scenario_var_data[73];
  photo_equalization = uniform_Update_scenario_var_data[74];
  mask_contrast = uniform_Update_scenario_var_data[75];
  Pixelstep = int(uniform_Update_scenario_var_data[76]);
  video_hue = uniform_Update_scenario_var_data[77];
  photo_hue = uniform_Update_scenario_var_data[78];
