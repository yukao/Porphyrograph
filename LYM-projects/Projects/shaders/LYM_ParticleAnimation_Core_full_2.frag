...
void main() {
  noiseParticleScale = uniform_ParticleAnimation_scenario_var_data[0];
  pixel_acc_shiftX = uniform_ParticleAnimation_scenario_var_data[1];
  pixel_acc_shiftY = uniform_ParticleAnimation_scenario_var_data[2];
  repop_path = uniform_ParticleAnimation_scenario_var_data[3];
  freeze = (uniform_ParticleAnimation_scenario_var_data[4] > 0 ? true : false);
  partDecay = uniform_ParticleAnimation_scenario_var_data[5];
  part_initialization = int(uniform_ParticleAnimation_scenario_var_data[6]);
  part_image_acceleration = int(uniform_ParticleAnimation_scenario_var_data[7]);
  part_path_follow_0 = (uniform_ParticleAnimation_scenario_var_data[8] > 0 ? true : false);
  part_path_follow_1 = (uniform_ParticleAnimation_scenario_var_data[9] > 0 ? true : false);
  part_path_follow_2 = (uniform_ParticleAnimation_scenario_var_data[10] > 0 ? true : false);
  part_path_follow_3 = (uniform_ParticleAnimation_scenario_var_data[11] > 0 ? true : false);
  part_path_follow_4 = (uniform_ParticleAnimation_scenario_var_data[12] > 0 ? true : false);
  part_path_follow_5 = (uniform_ParticleAnimation_scenario_var_data[13] > 0 ? true : false);
  part_path_follow_6 = (uniform_ParticleAnimation_scenario_var_data[14] > 0 ? true : false);
  part_path_follow_7 = (uniform_ParticleAnimation_scenario_var_data[15] > 0 ? true : false);
  part_path_follow_8 = (uniform_ParticleAnimation_scenario_var_data[16] > 0 ? true : false);
  part_path_follow_9 = (uniform_ParticleAnimation_scenario_var_data[17] > 0 ? true : false);
  part_path_follow_10 = (uniform_ParticleAnimation_scenario_var_data[18] > 0 ? true : false);
  part_path_follow_11 = (uniform_ParticleAnimation_scenario_var_data[19] > 0 ? true : false);
  part_path_repulse_0 = (uniform_ParticleAnimation_scenario_var_data[20] > 0 ? true : false);
  part_path_repulse_1 = (uniform_ParticleAnimation_scenario_var_data[21] > 0 ? true : false);
  part_path_repulse_2 = (uniform_ParticleAnimation_scenario_var_data[22] > 0 ? true : false);
  part_path_repulse_3 = (uniform_ParticleAnimation_scenario_var_data[23] > 0 ? true : false);
  part_path_repulse_4 = (uniform_ParticleAnimation_scenario_var_data[24] > 0 ? true : false);
  part_path_repulse_5 = (uniform_ParticleAnimation_scenario_var_data[25] > 0 ? true : false);
  part_path_repulse_6 = (uniform_ParticleAnimation_scenario_var_data[26] > 0 ? true : false);
  part_path_repulse_7 = (uniform_ParticleAnimation_scenario_var_data[27] > 0 ? true : false);
  part_path_repulse_8 = (uniform_ParticleAnimation_scenario_var_data[28] > 0 ? true : false);
  part_path_repulse_9 = (uniform_ParticleAnimation_scenario_var_data[29] > 0 ? true : false);
  part_path_repulse_10 = (uniform_ParticleAnimation_scenario_var_data[30] > 0 ? true : false);
  part_path_repulse_11 = (uniform_ParticleAnimation_scenario_var_data[31] > 0 ? true : false);
  part_size = uniform_ParticleAnimation_scenario_var_data[32];
  part_acc = uniform_ParticleAnimation_scenario_var_data[33];
  part_damp = uniform_ParticleAnimation_scenario_var_data[34];
  part_gravity = uniform_ParticleAnimation_scenario_var_data[35];
  part_field_weight = uniform_ParticleAnimation_scenario_var_data[36];
  part_damp_targtRad = uniform_ParticleAnimation_scenario_var_data[37];
  part_timeToTargt = uniform_ParticleAnimation_scenario_var_data[38];
  partMove_target = (uniform_ParticleAnimation_scenario_var_data[39] > 0 ? true : false);
  partMove_rand = (uniform_ParticleAnimation_scenario_var_data[40] > 0 ? true : false);
  partExit_mode = int(uniform_ParticleAnimation_scenario_var_data[41]);
  partStroke_mode = int(uniform_ParticleAnimation_scenario_var_data[42]);
  partColor_mode = int(uniform_ParticleAnimation_scenario_var_data[43]);
  repop_part = uniform_ParticleAnimation_scenario_var_data[44];
  Part_repop_density = int(uniform_ParticleAnimation_scenario_var_data[45]);
  Part_repop_color_mode = int(uniform_ParticleAnimation_scenario_var_data[46]);
