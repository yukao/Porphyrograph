...
uniform vec4 uniform_ParticleAnimation_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_repulse_0;
bool      part_path_repulse_1;
bool      part_path_repulse_2;
bool      part_path_repulse_3;
bool      freeze;
uniform vec4 uniform_ParticleAnimation_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_freeze;
...
uniform vec4 uniform_ParticleAnimation_fs_4fv_flashCAPartWght_nbPart_clear_partRadius; // 
 ...
 */
  ...
  flashToPartCumul += uniform_ParticleAnimation_fs_4fv_flashCAPartWght_nbPart_clear_partRadius.x
...
void main() {
  ...
  part_path_follow_1 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_repulse_0[0] > 0 ? true : false);
  part_path_follow_2 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_repulse_0[1] > 0 ? true : false);
  part_path_follow_3 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_repulse_0[2] > 0 ? true : false);
  part_path_repulse_0 = (uniform_ParticleAnimation_fs_4fv_part_path_follow_1_part_path_follow_2_part_path_follow_3_part_path_repulse_0[3] > 0 ? true : false);
  part_path_repulse_1 = (uniform_ParticleAnimation_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_freeze[0] > 0 ? true : false);
  part_path_repulse_2 = (uniform_ParticleAnimation_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_freeze[1] > 0 ? true : false);
  part_path_repulse_3 = (uniform_ParticleAnimation_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_freeze[2] > 0 ? true : false);
  freeze = (uniform_ParticleAnimation_fs_4fv_part_path_repulse_1_part_path_repulse_2_part_path_repulse_3_freeze[3] > 0 ? true : false);
  ...
  nbParticles = int(uniform_ParticleAnimation_fs_4fv_flashCAPartWght_nbPart_clear_partRadius.y);
  ...
  if(frameNo <= 10 || uniform_ParticleAnimation_fs_4fv_flashCAPartWght_nbPart_clear_partRadius.z > 0) {
