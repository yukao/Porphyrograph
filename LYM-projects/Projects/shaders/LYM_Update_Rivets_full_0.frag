...
void main() {
  ...
  video_threshold = uniform_Update_scenario_var_data[36];
  video_threshold_pulse = uniform_Update_scenario_var_data[37];
  video_gamma = uniform_Update_scenario_var_data[38];
  video_gamma_pulse = uniform_Update_scenario_var_data[39];
  photoWeight = uniform_Update_scenario_var_data[40];
  photo_threshold = uniform_Update_scenario_var_data[41];
  photo_threshold_pulse = uniform_Update_scenario_var_data[42];
  ...
  photo_offsetX = uniform_Update_scenario_var_data[46];
  photo_offsetY = uniform_Update_scenario_var_data[47];
