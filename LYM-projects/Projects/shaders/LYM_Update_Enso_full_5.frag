...
void main() {
  ...
  BG_CA_repop_density = int(uniform_Update_scenario_var_data[27]);
  movieWeight = uniform_Update_scenario_var_data[28];
  movieSobel = uniform_Update_scenario_var_data[29];
  invertMovie = (uniform_Update_scenario_var_data[30] > 0 ? true : false);
  video_satur = uniform_Update_scenario_var_data[31];
  video_gamma = uniform_Update_scenario_var_data[32];
  video_threshold = uniform_Update_scenario_var_data[33];
  photoWeight = uniform_Update_scenario_var_data[34];
  photo_satur = uniform_Update_scenario_var_data[35];
  photo_value = uniform_Update_scenario_var_data[36];
  photo_gamma = uniform_Update_scenario_var_data[37];
  photo_threshold = uniform_Update_scenario_var_data[38];
  mask_scale = uniform_Update_scenario_var_data[39];
  photo_contrast = uniform_Update_scenario_var_data[40];
  mask_contrast = uniform_Update_scenario_var_data[41];
  ...
  CAstep = int(uniform_Update_scenario_var_data[50]);
  CAcolorSpread = (uniform_Update_scenario_var_data[51] > 0 ? true : false);
  freeze = (uniform_Update_scenario_var_data[52] > 0 ? true : false);
  invertCamera = (uniform_Update_scenario_var_data[53] > 0 ? true : false);
  photo_scale = uniform_Update_scenario_var_data[54];
  cameraCumul = int(uniform_Update_scenario_var_data[55]);
  camera_BG_subtr = (uniform_Update_scenario_var_data[56] > 0 ? true : false);
  cameraGamma = uniform_Update_scenario_var_data[57];
  camera_gamma = uniform_Update_scenario_var_data[58];
  cameraThreshold = uniform_Update_scenario_var_data[59];
  cameraWeight = uniform_Update_scenario_var_data[60];
  cameraSobel = uniform_Update_scenario_var_data[61];
