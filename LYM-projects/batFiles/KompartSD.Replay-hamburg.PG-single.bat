...
if errorlevel 1 START .\OSC_replay-hamburg.bat
...
D:\sync.com\Sync\LYM-sources\Porphyrograph-VC17\Release\core_KompartSD\Porphyrograph_core_KompartSD.exe ./Projects/configuration/LYM_KompartSD-replay-head-single.csv ./Projects/scenarios/LYM_KompartSD-scenarioReplay-hamburg-v1.csv
