...
C:\home\LYM-sources\Porphyrograph-VC17\Release\core_Core\Porphyrograph_core_Core.exe ./Projects/configuration/LYM_FlowingForms-head-single.csv ./Projects/scenarios/LYM_FlowingForms-scenario-v2.csv
