...
D:\sync.com\Sync\LYM-sources\Porphyrograph-VC17\Release\core_GN\Porphyrograph_core_GN.exe ./Projects/configuration/LYM_GN-head-single.csv ./Projects/scenarios/LYM_GN-scenario-v1.csv
