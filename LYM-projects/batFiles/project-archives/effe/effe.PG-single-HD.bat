...
D:\cloud\Porphyrograph\Porphyrograph-VC15\Release\effe\Porphyrograph_effe.exe  ./effe/configuration/LYM_effe-head-single-HD.csv ./effe/scenarios/LYM_effe-scenario-v2.csv
