...
C:\sync.com\Sync\LYM-sources\Porphyrograph-VC17\Release\core_Pierres\Porphyrograph_core_Pierres.exe ./Projects/configuration/LYM_Pierres-head-single_screen.csv ./Projects/scenarios/LYM_Pierres-scenario-v3.csv
