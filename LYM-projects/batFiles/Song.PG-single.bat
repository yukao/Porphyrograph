...
C:\home\LYM-sources\Porphyrograph-VC17\Release\core_Core\Porphyrograph_core_Core.exe ./Projects/configuration/LYM_Song-head-single.csv ./Projects/scenarios/LYM_Song-scenario-v2.csv
