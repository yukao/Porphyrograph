...
system("./cmd/PG_configAndHeaderGenerator.prl alKemi/LYM_alKemi-head-single.conf alKemi/LYM_alKemi.csv alKemi/LYM_alKemi.conf");
...
system("nice -19 primusrun Porphyrograph/bin/PG_alKemi alKemi/LYM_alKemi.conf");
