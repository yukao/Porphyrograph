...
C:\sync.com\Sync\LYM-sources\Porphyrograph-VC17\Release\core_Core\Porphyrograph_core_Core.exe ./Projects/configuration/LYM_Song-head-single.csv ./Projects/scenarios/LYM_Song-scenario-v1.csv ./Projects/configuration/YN_Musicales_rejoice-head-single.csv ./Projects/scenarios/YN_Musicales_rejoice-scenario-v2.csv