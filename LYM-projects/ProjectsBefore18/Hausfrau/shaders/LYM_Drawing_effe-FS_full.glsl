...
int       noiseType;
uniform vec4 uniform_Drawing_fs_4fv_particleMode_noiseScale_noiseLineScale_noiseType;
float     noiseAngleScale;
float     noiseCenter_0;
float     noiseCenter_1;
float     partAccCenter_0;
uniform vec4 uniform_Drawing_fs_4fv_noiseAngleScale_noiseCenter_0_noiseCenter_1_partAccCenter_0;
float     partAccCenter_1;
float     repopulatingBG;
float     repopulatingCA;
int       CAType;
uniform vec4 uniform_Drawing_fs_4fv_partAccCenter_1_repopulatingBG_repopulatingCA_CAType;
int       CASubType;
int       currentDrawingTrack;
int       currentVideoTrack;
int       currentPhotoTrack;
uniform vec4 uniform_Drawing_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack;
bool      path_replay_0;
bool      path_replay_1;
bool      path_replay_2;
bool      path_replay_3;
uniform vec4 uniform_Drawing_fs_4fv_path_replay_0_path_replay_1_path_replay_2_path_replay_3;
float     CAdecay_pulse;
float     CAParams1;
float     CAParams2;
float     CAParams3;
uniform vec4 uniform_Drawing_fs_4fv_CAdecay_pulse_CAParams1_CAParams2_CAParams3;
float     CAParams4;
float     CAParams5;
float     CAParams6;
float     CAParams7;
uniform vec4 uniform_Drawing_fs_4fv_CAParams4_CAParams5_CAParams6_CAParams7;
float     CAParams8;
bool      invertMovie;
int       cameraCumul;
float     video_satur_pulse;
uniform vec4 uniform_Drawing_fs_4fv_CAParams8_invertMovie_cameraCumul_video_satur_pulse;
float     cameraWeight;
float     movieWeight;
float     cameraSobel;
float     movieSobel;
uniform vec4 uniform_Drawing_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel;
int       CAstep;
bool      CAcolorSpread;
bool      freeze;
uniform vec3 uniform_Drawing_fs_3fv_CAstep_CAcolorSpread_freeze;
...
void main() {
  particleMode = int(uniform_Drawing_fs_4fv_particleMode_noiseScale_noiseLineScale_noiseType[0]);
  noiseScale = uniform_Drawing_fs_4fv_particleMode_noiseScale_noiseLineScale_noiseType[1];
  noiseLineScale = uniform_Drawing_fs_4fv_particleMode_noiseScale_noiseLineScale_noiseType[2];
  noiseType = int(uniform_Drawing_fs_4fv_particleMode_noiseScale_noiseLineScale_noiseType[3]);
  noiseAngleScale = uniform_Drawing_fs_4fv_noiseAngleScale_noiseCenter_0_noiseCenter_1_partAccCenter_0[0];
  noiseCenter_0 = uniform_Drawing_fs_4fv_noiseAngleScale_noiseCenter_0_noiseCenter_1_partAccCenter_0[1];
  noiseCenter_1 = uniform_Drawing_fs_4fv_noiseAngleScale_noiseCenter_0_noiseCenter_1_partAccCenter_0[2];
  partAccCenter_0 = uniform_Drawing_fs_4fv_noiseAngleScale_noiseCenter_0_noiseCenter_1_partAccCenter_0[3];
  partAccCenter_1 = uniform_Drawing_fs_4fv_partAccCenter_1_repopulatingBG_repopulatingCA_CAType[0];
  repopulatingBG = uniform_Drawing_fs_4fv_partAccCenter_1_repopulatingBG_repopulatingCA_CAType[1];
  repopulatingCA = uniform_Drawing_fs_4fv_partAccCenter_1_repopulatingBG_repopulatingCA_CAType[2];
  CAType = int(uniform_Drawing_fs_4fv_partAccCenter_1_repopulatingBG_repopulatingCA_CAType[3]);
  CASubType = int(uniform_Drawing_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[0]);
  currentDrawingTrack = int(uniform_Drawing_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[1]);
  currentVideoTrack = int(uniform_Drawing_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[2]);
  currentPhotoTrack = int(uniform_Drawing_fs_4fv_CASubType_currentDrawingTrack_currentVideoTrack_currentPhotoTrack[3]);
  path_replay_0 = (uniform_Drawing_fs_4fv_path_replay_0_path_replay_1_path_replay_2_path_replay_3[0] > 0 ? true : false);
  path_replay_1 = (uniform_Drawing_fs_4fv_path_replay_0_path_replay_1_path_replay_2_path_replay_3[1] > 0 ? true : false);
  path_replay_2 = (uniform_Drawing_fs_4fv_path_replay_0_path_replay_1_path_replay_2_path_replay_3[2] > 0 ? true : false);
  path_replay_3 = (uniform_Drawing_fs_4fv_path_replay_0_path_replay_1_path_replay_2_path_replay_3[3] > 0 ? true : false);
  CAdecay_pulse = uniform_Drawing_fs_4fv_CAdecay_pulse_CAParams1_CAParams2_CAParams3[0];
  CAParams1 = uniform_Drawing_fs_4fv_CAdecay_pulse_CAParams1_CAParams2_CAParams3[1];
  CAParams2 = uniform_Drawing_fs_4fv_CAdecay_pulse_CAParams1_CAParams2_CAParams3[2];
  CAParams3 = uniform_Drawing_fs_4fv_CAdecay_pulse_CAParams1_CAParams2_CAParams3[3];
  CAParams4 = uniform_Drawing_fs_4fv_CAParams4_CAParams5_CAParams6_CAParams7[0];
  CAParams5 = uniform_Drawing_fs_4fv_CAParams4_CAParams5_CAParams6_CAParams7[1];
  CAParams6 = uniform_Drawing_fs_4fv_CAParams4_CAParams5_CAParams6_CAParams7[2];
  CAParams7 = uniform_Drawing_fs_4fv_CAParams4_CAParams5_CAParams6_CAParams7[3];
  CAParams8 = uniform_Drawing_fs_4fv_CAParams8_invertMovie_cameraCumul_video_satur_pulse[0];
  invertMovie = (uniform_Drawing_fs_4fv_CAParams8_invertMovie_cameraCumul_video_satur_pulse[1] > 0 ? true : false);
  cameraCumul = int(uniform_Drawing_fs_4fv_CAParams8_invertMovie_cameraCumul_video_satur_pulse[2]);
  video_satur_pulse = uniform_Drawing_fs_4fv_CAParams8_invertMovie_cameraCumul_video_satur_pulse[3];
  cameraWeight = uniform_Drawing_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[0];
  movieWeight = uniform_Drawing_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[1];
  cameraSobel = uniform_Drawing_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[2];
  movieSobel = uniform_Drawing_fs_4fv_cameraWeight_movieWeight_cameraSobel_movieSobel[3];
  CAstep = int(uniform_Drawing_fs_3fv_CAstep_CAcolorSpread_freeze[0]);
  CAcolorSpread = (uniform_Drawing_fs_3fv_CAstep_CAcolorSpread_freeze[1] > 0 ? true : false);
  freeze = (uniform_Drawing_fs_3fv_CAstep_CAcolorSpread_freeze[2] > 0 ? true : false);
