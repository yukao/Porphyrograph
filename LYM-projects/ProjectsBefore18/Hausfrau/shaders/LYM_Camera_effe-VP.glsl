/***********************************************************************
File: effe/shaders/LYM_Camera_effe-VP.glsl
...
uniform vec2 uniform_Camera_vp_2fv_width_height;
...
void main() {
  ...
  // passe les coordonnees de texture POT (decalCoords), 
  decalCoordsPOT = texcoord/uniform_Camera_vp_2fv_width_height;
}
