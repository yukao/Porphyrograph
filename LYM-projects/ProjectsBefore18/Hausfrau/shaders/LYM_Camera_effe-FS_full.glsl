...
float     cameraGamma;
bool      BGSubtr;
uniform vec3 uniform_Camera_fs_3fv_cameraThreshold_cameraGamma_BGSubtr;
...
void main() {
  cameraThreshold = uniform_Camera_fs_3fv_cameraThreshold_cameraGamma_BGSubtr[0];
  cameraGamma = uniform_Camera_fs_3fv_cameraThreshold_cameraGamma_BGSubtr[1];
  BGSubtr = (uniform_Camera_fs_3fv_cameraThreshold_cameraGamma_BGSubtr[2] > 0 ? true : false);
  float videoGray = 0.0;
