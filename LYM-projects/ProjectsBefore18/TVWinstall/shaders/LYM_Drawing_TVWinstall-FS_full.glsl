...
float     image_value;
uniform vec4 uniform_Drawing_fs_4fv_CAType_CASubType_images_weights_scale_image_value;
float     image_value_pulse;
float     image_satur;
float     image_satur_pulse;
float     mask_contrast;
uniform vec4 uniform_Drawing_fs_4fv_image_value_pulse_image_satur_image_satur_pulse_mask_contrast;
float     mask_threshold;
float     image_contrast;
bool      freeze;
uniform vec3 uniform_Drawing_fs_3fv_mask_threshold_image_contrast_freeze;
...
void main() {
  ...
  CAType = int(uniform_Drawing_fs_4fv_CAType_CASubType_images_weights_scale_image_value[0]);
  CASubType = int(uniform_Drawing_fs_4fv_CAType_CASubType_images_weights_scale_image_value[1]);
  images_weights_scale = uniform_Drawing_fs_4fv_CAType_CASubType_images_weights_scale_image_value[2];
  image_value = uniform_Drawing_fs_4fv_CAType_CASubType_images_weights_scale_image_value[3];
  image_value_pulse = uniform_Drawing_fs_4fv_image_value_pulse_image_satur_image_satur_pulse_mask_contrast[0];
  image_satur = uniform_Drawing_fs_4fv_image_value_pulse_image_satur_image_satur_pulse_mask_contrast[1];
  image_satur_pulse = uniform_Drawing_fs_4fv_image_value_pulse_image_satur_image_satur_pulse_mask_contrast[2];
  mask_contrast = uniform_Drawing_fs_4fv_image_value_pulse_image_satur_image_satur_pulse_mask_contrast[3];
  mask_threshold = uniform_Drawing_fs_3fv_mask_threshold_image_contrast_freeze[0];
  image_contrast = uniform_Drawing_fs_3fv_mask_threshold_image_contrast_freeze[1];
  freeze = (uniform_Drawing_fs_3fv_mask_threshold_image_contrast_freeze[2] > 0 ? true : false);
