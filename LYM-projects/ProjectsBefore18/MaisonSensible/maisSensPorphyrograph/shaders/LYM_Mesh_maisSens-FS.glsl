...
*/
    ...
    /*
  	...
  	else if( decalCoords.x > uniform_MeshDisplay_fs_2i_FBOwh.x && 
	  decalCoords.y > uniform_MeshDisplay_fs_2i_FBOwh.y ) {
  		outColor0 = vec4(0.0,1.0,0.0,1.0);
  	}
  	else if( decalCoords.y < 0.0 && 
	  decalCoords.x > uniform_MeshDisplay_fs_2i_FBOwh.x ) {
  		outColor0 = vec4(1.0,1.0,0.0,1.0);
  	}
    else if( decalCoords.x < 0.0 && 
             decalCoords.y > 512.0 ) {
    ...
    else if( decalCoords.y > uniform_MeshDisplay_fs_2i_FBOwh.y ) {
      outColor0 = vec4(1.0,0.0,0.5,1.0);
    }
  	else if( decalCoords.y < 0.0 ) {
  		outColor0 = vec4(0.0,1.0,1.0,1.0);
  	}
  	else if(  decalCoords.x > uniform_MeshDisplay_fs_2i_FBOwh.x ) {
