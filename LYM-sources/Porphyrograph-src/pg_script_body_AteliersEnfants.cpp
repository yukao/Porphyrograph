...
float repop_huePart       ;
float repop_huePart_pulse ;
float repop_satPart       ;
float repop_satPart_pulse ;
float repop_valuePart     ;
float repop_valuePart_pulse;
float repop_colorCA       ;
...
void trkDecay_1_callBack_generic(pg_Parameter_Input_Type param_input_type, ScenarioValue scenario_or_gui_command_value) {
	trkDecay_1_callBack(param_input_type, float(scenario_or_gui_command_value.val_num));
}
...
char *ScenarioVarMessages[_MaxInterpVarIDs] = { 
  ...
  (char *)"repop_huePart",
  (char *)"repop_huePart_pulse",
  (char *)"repop_satPart",
  (char *)"repop_satPart_pulse",
  (char *)"repop_valuePart",
  (char *)"repop_valuePart_pulse",
  (char *)"repop_colorCA",
