...
void parseConfigurationFile(std::ifstream& confFin, std::ifstream&  scenarioFin) {
	...
	printf("Window %dx%d w:%d+%d TopLeft %dx%d\n",
		window_width, window_height, leftWindowWidth, rightWindowWidth, window_x, window_y);
	...
	for (int indPrerecPath = 0; indPrerecPath < nb_svg_paths; indPrerecPath++) {
		...
		SVGpaths[indPrerecPath].SVG_path_init(indPath, indTrack, pathRadius, path_r_color, path_g_color, path_b_color, path_readSpeedScale, path_ID, fileName, path_group);
...
void setWindowDimensions(void) {
	...
	window_width_powerOf2_ratio =
		float(window_width) / float(window_width_powerOf2);
	...
	//printf("leftWindowWidth %d rightWindowWidth %d doubleWindowWidth %d leftWindowWidth_powerOf2 %d window_height_powerOf2 %d window_height_powerOf2_ratio %2f\n",
	//	leftWindowWidth, rightWindowWidth, doubleWindowWidth, leftWindowWidth_powerOf2, window_height_powerOf2, window_height_powerOf2_ratio);
}
