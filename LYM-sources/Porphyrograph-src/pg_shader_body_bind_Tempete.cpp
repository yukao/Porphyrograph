  ...
  uniform_ParticleAnimation_scenario_var_data = glGetUniformLocation(shader_programme[pg_shader_ParticleAnimation], "uniform_ParticleAnimation_scenario_var_data");
  if ( uniform_ParticleAnimation_scenario_var_data == -1 ) {
    fprintf(stderr, "Could not bind uniform ParticleAnimation uniform_ParticleAnimation_scenario_var_data : %d\n" , uniform_ParticleAnimation_scenario_var_data );
  }
