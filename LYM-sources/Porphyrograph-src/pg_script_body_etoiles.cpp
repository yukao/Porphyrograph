...
float photo_offsetX       ;
float photo_offsetX_pulse ;
float photo_offsetY       ;
float photo_offsetY_pulse ;
float mask_scale          ;
...
void * ScenarioVarPointers[_MaxInterpVarIDs] = { 
   ...
   (void *)&photo_scale,
   (void *)&photo_scale_pulse,
   (void *)&photo_offsetX,
   (void *)&photo_offsetX_pulse,
   (void *)&photo_offsetY,
   (void *)&photo_offsetY_pulse,
   (void *)&mask_scale,
   (void *)&photo_contrast,
   (void *)&mask_contrast,
   (void *)&CAParams1,
...
char *ScenarioVarMessages[_MaxInterpVarIDs] = { 
  ...
  (char *)"photo_scale",
  (char *)"photo_scale_pulse",
  (char *)"photo_offsetX",
  (char *)"photo_offsetX_pulse",
  (char *)"photo_offsetY",
  (char *)"photo_offsetY_pulse",
  (char *)"mask_scale",
  (char *)"photo_contrast",
  (char *)"mask_contrast",
  (char *)"CAParams1",
