  ...
  uniform_Update_fs_4fv_repop_BG_cameraGamma_activeClipArts_cameraThreshold 
    = glGetUniformLocation(shader_programme[pg_shader_Update], "uniform_Update_fs_4fv_repop_BG_cameraGamma_activeClipArts_cameraThreshold");
  if ( uniform_Update_fs_4fv_repop_BG_cameraGamma_activeClipArts_cameraThreshold == -1 ) {
    fprintf(stderr, "Could not bind uniform Update uniform_Update_fs_4fv_repop_BG_cameraGamma_activeClipArts_cameraThreshold : %d\n" , uniform_Update_fs_4fv_repop_BG_cameraGamma_activeClipArts_cameraThreshold );
  }
  ...
  uniform_Master_fs_4fv_trackMasterWeight_2_trackMasterWeight_3_master_mask_scale_master_mask_offsetX 
    = glGetUniformLocation(shader_programme[pg_shader_Master], "uniform_Master_fs_4fv_trackMasterWeight_2_trackMasterWeight_3_master_mask_scale_master_mask_offsetX");
  if ( uniform_Master_fs_4fv_trackMasterWeight_2_trackMasterWeight_3_master_mask_scale_master_mask_offsetX == -1 ) {
    fprintf(stderr, "Could not bind uniform Master uniform_Master_fs_4fv_trackMasterWeight_2_trackMasterWeight_3_master_mask_scale_master_mask_offsetX : %d\n" , uniform_Master_fs_4fv_trackMasterWeight_2_trackMasterWeight_3_master_mask_scale_master_mask_offsetX );
  }
  ...
  uniform_Master_fs_2fv_master_mask_offsetY_interfaceOnScreen 
    = glGetUniformLocation(shader_programme[pg_shader_Master], "uniform_Master_fs_2fv_master_mask_offsetY_interfaceOnScreen");
  if ( uniform_Master_fs_2fv_master_mask_offsetY_interfaceOnScreen == -1 ) {
    fprintf(stderr, "Could not bind uniform Master uniform_Master_fs_2fv_master_mask_offsetY_interfaceOnScreen : %d\n" , uniform_Master_fs_2fv_master_mask_offsetY_interfaceOnScreen );
  }
