 ...
 Update_scenario_var_data[32] = (GLfloat)video_satur * (1.f + pulse_average * video_satur_pulse);
 Update_scenario_var_data[33] = (GLfloat)video_satur_pulse;
 Update_scenario_var_data[34] = (GLfloat)video_value * (1.f + pulse_average * video_value_pulse);
 ...
 Update_scenario_var_data[37] = (GLfloat)photo_value_pulse;
 Update_scenario_var_data[38] = (GLfloat)photo_gamma * (1.f + pulse_average * photo_gamma_pulse);
 Update_scenario_var_data[39] = (GLfloat)photo_gamma_pulse;
 Update_scenario_var_data[40] = (GLfloat)photo_threshold * (1.f + pulse_average * photo_threshold_pulse);
 ...
 Master_scenario_var_data[7] = (GLfloat)master_scale * (1.f + pulse_average * master_scale_pulse);
 Master_scenario_var_data[8] = (GLfloat)master_scale_pulse;
 Master_scenario_var_data[9] = (GLfloat)master_scale_ratio;
 Master_scenario_var_data[10] = (GLfloat)master_offsetX;
 Master_scenario_var_data[11] = (GLfloat)master_offsetY;
