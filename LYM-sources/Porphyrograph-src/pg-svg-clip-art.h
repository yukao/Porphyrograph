/* nvpr_init.h - initialize NVPR API */
/* Copyright NVIDIA Corporation, 2010. */

#ifndef __PG_SVG_GPU_H__
#define __PG_SVG_GPU_H__
...
#define GL_PATH_SVG_stroke_width_NV                             0x9075
...
extern GLuint SVG_path_baseID;
// fill color table
extern GLint *SVG_path_fill_color;

extern int has_NV_path_rendering;

extern bool SVG_stroke_onOff;
extern bool SVG_fill_onOff;
extern float SVG_fill_color_shift;
extern float SVG_stroke_width;
extern int SVG_fill_color_swap;
extern float SVG_fill_color_brightness;
extern int SVG_stroke_color_swap;
