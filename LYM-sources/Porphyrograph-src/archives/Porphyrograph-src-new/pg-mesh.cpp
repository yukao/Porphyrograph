...
void ParseScenarioMeshes(std::ifstream& scenarioFin, int indConfiguration) {
	...
	while (true) {
		...
		if (pg_FullScenarioActiveVars[pg_current_configuration_rank][_activeMeshes]) {
			...
			sprintf(ErrorStr, "Error: incorrect configuration file unexpected mesh definition at \"%s\"", ID.c_str()); ReportError(ErrorStr); throw 100;
		}
	}
...
void update_anim(int indMeshFile) {
	if (pg_FullScenarioActiveVars[pg_current_configuration_rank][_mesh_anime]) {
		if (mesh_anime < 0) {
			mesh_anime_precTime[pg_current_configuration_rank][indMeshFile] = pg_CurrentClockTime;
		}
		bool new_anim = mesh_anime != mesh_precedingAnime[pg_current_configuration_rank][indMeshFile];
		if (new_anim) {
			mesh_startAnime[pg_current_configuration_rank][indMeshFile] = pg_CurrentClockTime;
			mesh_precedingAnime[pg_current_configuration_rank][indMeshFile] = mesh_anime;
		}
		switch (mesh_anime) {
			// frozen
		case 0: {
		...
		case 1: {
			...
			pg_interpolation_weight_AnimationPose[pg_current_configuration_rank][indMeshFile][0] = float((sin((pg_CurrentClockTime - mesh_startAnime[pg_current_configuration_rank][indMeshFile]) * mesh_anime_speed) + 1.f) / 2.f);
		...
		case 2: {
			...
			float Pose0 = float((sin((pg_CurrentClockTime - mesh_startAnime[pg_current_configuration_rank][indMeshFile]) * mesh_anime_speed) + 1.f) / 2.f);
		...
		case 3: {
			...
			float pose = float((sin((pg_CurrentClockTime - mesh_startAnime[pg_current_configuration_rank][indMeshFile]) * mesh_anime_speed) + 1.f) / 2.f);
...
void mesh_update_motion(int indMeshFile) {
	...
	bool new_motion = mesh_motion != mesh_precedingMotion[pg_current_configuration_rank][indMeshFile];
	bool with_motion = false;
	if (new_motion) {
		mesh_startMotion[pg_current_configuration_rank][indMeshFile] = pg_CurrentClockTime;
		mesh_precedingMotion[pg_current_configuration_rank][indMeshFile] = mesh_motion;
	}
	switch (mesh_motion) {
		// frozen
	case 0: {
	...
	case 1: {
		if (new_motion) {
			...
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Translation_Y = mesh_translation_Y;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Translation_Y = mesh_translation_Y;
			...
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Scale = mesh_scale;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Scale = mesh_scale;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_X = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_X;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Rotation_X = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_X;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_Y = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_Y;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Rotation_Y = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_Y;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_Z = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_Z;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Rotation_Z = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_Z;
		}
		pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] = float((sin((pg_CurrentClockTime - mesh_startMotion[pg_current_configuration_rank][indMeshFile]) * mesh_anime_speed) + 1.f) / 2.f);
	...
	case 3: {
		if (new_motion) {
			...
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Translation_X = mesh_translation_X * (indMeshFile % 2 == 0 ? 1 : -1);
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Translation_X = mesh_translation_X * (indMeshFile % 2 == 0 ? 1 : -1);
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Translation_Y = mesh_translation_Y;
			pg_motionPoses[pg_current_configuration_rank][indMeshFile][1].pose_Mesh_Translation_Y = mesh_translation_Y;
		...
		pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] = float((sin((pg_CurrentClockTime - mesh_startMotion[pg_current_configuration_rank][indMeshFile]) * mesh_motion_speed) + 1.f) / 2.f);
		pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][1] = 1.f - pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0];
		with_motion = true;
		break;
	}
	...
	if (with_motion) {
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_X = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Translation_X
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_Y = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Translation_Y
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_angle = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_angle
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Scale = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Scale
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_X = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_X
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Y = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_Y
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Z = pg_interpolation_weight_MotionPose[pg_current_configuration_rank][indMeshFile][0] * pg_motionPoses[pg_current_configuration_rank][indMeshFile][0].pose_Mesh_Rotation_Z
		...
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_X = mesh_translation_X * (indMeshFile % 2 == 0 ? 1 : -1);
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_Y = mesh_translation_Y;
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_angle = mesh_rotation * (indMeshFile % 2 == 0 ? 1 : -1);
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Scale = mesh_scale;
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_X = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_X;
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Y = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_Y;
		pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Z = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_Ini_Z;
	}
	// pulse update
	pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_X = (pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_X + mesh_translation_X_pulse * (pulse_average - 0.5f));
	pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_Y = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Translation_Y + mesh_translation_Y_pulse * (pulse_average - 0.5f);
	pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_angle = (pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Rotation_angle + mesh_rotation_pulse * (pulse_average - 0.5f));
	pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Scale = pg_Meshes[pg_current_configuration_rank][indMeshFile].pg_Mesh_Scale + mesh_scale_pulse * (pulse_average - 0.5f);
