...
Update_scenario_var_data[23] = (GLfloat)photo_color_balance_r * (1.f + pulse_average * photo_color_balance_r_pulse);
Update_scenario_var_data[24] = (GLfloat)photo_color_balance_g * (1.f + pulse_average * photo_color_balance_g_pulse);
Update_scenario_var_data[25] = (GLfloat)photo_color_balance_b * (1.f + pulse_average * photo_color_balance_b_pulse);
Update_scenario_var_data[26] = (GLfloat)photo_contrast * (1.f + pulse_average * photo_contrast_pulse);
Update_scenario_var_data[27] = (GLfloat)photo_gamma * (1.f + pulse_average * photo_gamma_pulse);
Update_scenario_var_data[28] = (GLfloat)photo_hue * (1.f + pulse_average * photo_hue_pulse);
Update_scenario_var_data[29] = (GLfloat)photo_rot;
Update_scenario_var_data[30] = (GLfloat)photo_satur * (1.f + pulse_average * photo_satur_pulse);
Update_scenario_var_data[31] = (GLfloat)photo_scaleX;
Update_scenario_var_data[32] = (GLfloat)photo_scaleY;
Update_scenario_var_data[33] = (GLfloat)photo_threshold * (1.f + pulse_average * photo_threshold_pulse);
Update_scenario_var_data[34] = (GLfloat)photo_transl_x;
Update_scenario_var_data[35] = (GLfloat)photo_transl_y;
Update_scenario_var_data[36] = (GLfloat)photo_value * (1.f + pulse_average * photo_value_pulse);
Update_scenario_var_data[37] = (GLfloat)photoSobel * (1.f + pulse_average * photoSobel_pulse);
Update_scenario_var_data[38] = (GLfloat)photoWeight * (1.f + pulse_average * photoWeight_pulse);
Update_scenario_var_data[39] = (GLfloat)video_contrast * (1.f + pulse_average * video_contrast_pulse);
Update_scenario_var_data[40] = (GLfloat)video_gamma * (1.f + pulse_average * video_gamma_pulse);
Update_scenario_var_data[41] = (GLfloat)video_hue * (1.f + pulse_average * video_hue_pulse);
Update_scenario_var_data[42] = (GLfloat)video_satur * (1.f + pulse_average * video_satur_pulse);
Update_scenario_var_data[43] = (GLfloat)video_threshold * (1.f + pulse_average * video_threshold_pulse);
Update_scenario_var_data[44] = (GLfloat)video_value * (1.f + pulse_average * video_value_pulse);
Update_scenario_var_data[45] = (GLfloat)video_white * (1.f + pulse_average * video_white_pulse);
Update_scenario_var_data[46] = (GLfloat)noiseType;
Update_scenario_var_data[47] = (GLfloat)noiseLineScale;
Update_scenario_var_data[48] = (GLfloat)noiseAngleScale;
Update_scenario_var_data[49] = (GLfloat)noiseCenterX;
Update_scenario_var_data[50] = (GLfloat)noiseCenterY;
Update_scenario_var_data[51] = (GLfloat)path_replay_trackNo[1];
Update_scenario_var_data[52] = (GLfloat)path_replay_trackNo[2];
Update_scenario_var_data[53] = (GLfloat)path_replay_trackNo[3];
Update_scenario_var_data[54] = (GLfloat)path_replay_trackNo[4];
Update_scenario_var_data[55] = (GLfloat)path_replay_trackNo[5];
Update_scenario_var_data[56] = (GLfloat)path_replay_trackNo[6];
Update_scenario_var_data[57] = (GLfloat)path_replay_trackNo[7];
Update_scenario_var_data[58] = (GLfloat)path_replay_trackNo[8];
Update_scenario_var_data[59] = (GLfloat)path_replay_trackNo[9];
Update_scenario_var_data[60] = (GLfloat)path_replay_trackNo[10];
Update_scenario_var_data[61] = (GLfloat)path_replay_trackNo[11];
Update_scenario_var_data[62] = (GLfloat)Pixelstep;
Update_scenario_var_data[63] = (GLfloat)noiseUpdateScale * (1.f + pulse_average * noiseUpdateScale_pulse);
Update_scenario_var_data[64] = (GLfloat)pixel_acc * (1.f + pulse_average * pixel_acc_pulse);
Update_scenario_var_data[65] = (GLfloat)pixel_acc_shiftX * (1.f + pulse_average * pixel_acc_shiftX_pulse);
Update_scenario_var_data[66] = (GLfloat)pixel_acc_shiftY * (1.f + pulse_average * pixel_acc_shiftY_pulse);
Update_scenario_var_data[67] = (GLfloat)pixel_image_acceleration;
Update_scenario_var_data[68] = (GLfloat)pixel_mode;
Update_scenario_var_data[69] = (GLfloat)pixel_radius * (1.f + pulse_average * pixel_radius_pulse);
Update_scenario_var_data[70] = (GLfloat)BG_CA_repop_color_mode;
Update_scenario_var_data[71] = (GLfloat)BG_CA_repop_density;
Update_scenario_var_data[72] = (GLfloat)repop_BG * (1.f + pulse_average * repop_BG_pulse);
Update_scenario_var_data[73] = (GLfloat)repop_CA * (1.f + pulse_average * repop_CA_pulse);
Update_scenario_var_data[74] = (GLfloat)camera_BG_subtr;
Update_scenario_var_data[75] = (GLfloat)freeze;
Update_scenario_var_data[76] = (GLfloat)screenLayout;
Update_scenario_var_data[77] = (GLfloat)CAdecay + pulse_average * CAdecay_pulse;
Update_scenario_var_data[78] = (GLfloat)trkDecay[0] * (1.f + pulse_average * trkDecay_pulse[0]);
Update_scenario_var_data[79] = (GLfloat)trkDecay[1] * (1.f + pulse_average * trkDecay_pulse[1]);
Update_scenario_var_data[80] = (GLfloat)trkDecay[2] * (1.f + pulse_average * trkDecay_pulse[2]);
Update_scenario_var_data[81] = (GLfloat)trkDecay[3] * (1.f + pulse_average * trkDecay_pulse[3]);
Update_scenario_var_data[82] = (GLfloat)currentDrawingTrack;
Update_scenario_var_data[83] = (GLfloat)currentPhotoTrack;
Update_scenario_var_data[84] = (GLfloat)currentVideoTrack;
Update_scenario_var_data[85] = (GLfloat)fft_scale;
...
if (pg_shader_programme[pg_ind_scenario][pg_enum_shader_Update]) {
  ...
  glUniform1fv(uniform_Update_scenario_var_data[pg_ind_scenario], 86, Update_scenario_var_data);
}
