...
#define var_AT5_shutter
#define var_AT5_stop_motion
enum InterpVarIDs{ 
  _auto_beat = 0,
  _auto_pulse,
  _clearAllLayers,
...
extern float AT5_shutter         ;
extern int   AT5_stop_motion     ;
