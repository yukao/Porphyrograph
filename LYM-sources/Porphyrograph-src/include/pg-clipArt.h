...
extern int pg_nb_tot_SvgGpu_paths[PG_MAX_SCENARIOS];

// base ID of the GPU paths
extern GLuint pg_ClipArt_path_baseID[PG_MAX_SCENARIOS];
// fill color table
extern unsigned int** pg_ClipArt_path_fill_color[PG_MAX_SCENARIOS];
...
void pg_ClipArt_OnOff(int indImage);
void pg_ClipArt_Off(int indImage);
void pg_ClipArt_On(int indImage);
