...
enum pg_light_command_hashMap_IDs {	pg_enum_dimmer = 0,
...
public:
	...
	bool get_one_non_null_pulse(void) {
		return (group_val_pulse[pg_enum_dimmer] != 0.f || group_val_pulse[pg_enum_light_strobe] != 0.f || group_val_pulse[pg_enum_light_zoom] != 0.f || group_val_pulse[pg_enum_light_pan] != 0.f || group_val_pulse[pg_enum_light_tilt] != 0.f
