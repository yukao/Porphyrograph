...
// initial values in the scenario (before first scene)
extern ScenarioValue InitialValuesInterpVar[_MaxInterpVarIDs][PG_MAX_CONFIGURATIONS];
// rank of the scenario variable in the list of variables generated by python
extern int ConfigScenarioVarRank[_MaxInterpVarIDs][PG_MAX_CONFIGURATIONS];
// var IDs in scenarios in the order in which they appear in the scenario
extern string ConfigScenarioVarIDs[_MaxInterpVarIDs][PG_MAX_CONFIGURATIONS];
// number of vars in the scenario file
extern int ScenarioVarNb[PG_MAX_CONFIGURATIONS];
// last value shipped to the GUI (PD)
extern float LastGUIShippedValuesInterpVar[_MaxInterpVarIDs][PG_MAX_CONFIGURATIONS];
