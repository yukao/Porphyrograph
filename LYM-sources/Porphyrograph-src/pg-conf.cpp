...
void parseConfigurationFile(std::ifstream& confFin, std::ifstream&  scenarioFin) {
	...
	//scene_IDs = new string[pg_NbScenes];
	//scene_duration = new float[pg_NbScenes];
	//scene_initial_time = new float[pg_NbScenes];
	//scene_final_time = new float[pg_NbScenes];
	//scene_originalDuration = new float[pg_NbScenes];
	//scene_originalInitial_time = new float[pg_NbScenes];
	//scene_originalFinal_time = new float[pg_NbScenes];
