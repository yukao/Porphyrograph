...
float light6_color_pulse  ;
float light6_grey_pulse   ;
float light6_dimmer_pulse ;
float light6_strobe_pulse ;
float light7_color_pulse  ;
float light7_grey_pulse   ;
float light7_dimmer_pulse ;
float light7_strobe_pulse ;
float light8_color_pulse  ;
float light8_grey_pulse   ;
float light8_dimmer_pulse ;
float light8_strobe_pulse ;
...
void * ScenarioVarPointers[_MaxInterpVarIDs] = { 
	...
	(void *)&light6_color_pulse,
	(void *)&light6_grey_pulse,
	(void *)&light6_dimmer_pulse,
	(void *)&light6_strobe_pulse,
	(void *)&light7_color_pulse,
	(void *)&light7_grey_pulse,
	(void *)&light7_dimmer_pulse,
	(void *)&light7_strobe_pulse,
	(void *)&light8_color_pulse,
	(void *)&light8_grey_pulse,
	(void *)&light8_dimmer_pulse,
	(void *)&light8_strobe_pulse,
};
...
void (*ScenarioVarCallbacks[_MaxInterpVarIDs])(pg_Parameter_Input_Type, double) = { 
	...
	&extern_movieNo_callBack,
	NULL,
	&photo_diaporama_callBack,
	NULL,
	NULL,
	NULL,
	&activeMeshes_callBack,
	&mobileMeshes_callBack,
	...
	NULL,
	NULL,
	&Caverne_Mesh_Profusion_callBack,
	NULL,
	NULL,
	NULL,
	NULL,
...
char *ScenarioVarMessages[_MaxInterpVarIDs] = { 
  ...
  (char *)"light6_color_pulse",
  (char *)"light6_grey_pulse",
  (char *)"light6_dimmer_pulse",
  (char *)"light6_strobe_pulse",
  (char *)"light7_color_pulse",
  (char *)"light7_grey_pulse",
  (char *)"light7_dimmer_pulse",
  (char *)"light7_strobe_pulse",
  (char *)"light8_color_pulse",
  (char *)"light8_grey_pulse",
  (char *)"light8_dimmer_pulse",
  (char *)"light8_strobe_pulse",
};
