...
def create_training_set():
    ...
    # training_set = xmm.new_TrainingSet()
    training_set = xmm.TrainingSet()
    # training_set.TrainingSet_dimension_input_set(6) # dimension of data in this example
    # AttributeError: 'SwigPyObject' object has no attribute 'TrainingSet_dimension_input_set'
    # swig/python detected a memory leak of type 'xmm::TrainingSet *', no destructor found.
