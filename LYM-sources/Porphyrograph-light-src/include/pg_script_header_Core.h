...
#define var_lavoirs_mask_opacity_wall
#define var_lavoirs_mask_opacity_posts
#define var_lavoirs_mask_opacity_roof
#define var_lavoirs_mask_opacity_ground
#define var_lavoirs_mask_Mixing_wall
#define var_lavoirs_mask_Mixing_posts
#define var_lavoirs_mask_Mixing_roof
#define var_lavoirs_mask_Mixing_ground
...
enum InterpVarIDs{ 
  ...
  _light_strobe,
  _light_strobe_pulse,
  _lavoirs_mask_opacity_wall,
  _lavoirs_mask_opacity_posts,
  _lavoirs_mask_opacity_roof,
  _lavoirs_mask_opacity_ground,
  _lavoirs_mask_Mixing_wall,
  _lavoirs_mask_Mixing_posts,
  _lavoirs_mask_Mixing_roof,
  _lavoirs_mask_Mixing_ground,
  _currentLightScene,
  _MaxInterpVarIDs};
...
extern float lavoirs_mask_opacity_wall[6];
extern float lavoirs_mask_opacity_posts[6];
extern float lavoirs_mask_opacity_roof[6];
extern float lavoirs_mask_opacity_ground[6];
extern float lavoirs_mask_Mixing_wall[6];
extern float lavoirs_mask_Mixing_posts[6];
extern float lavoirs_mask_Mixing_roof[6];
extern float lavoirs_mask_Mixing_ground[6];
