...
enum InterpolationType{ pg_linear_interpolation = 0, pg_cosine_interpolation , pg_stepwise_interpolation , pg_keep_value , EmptyInterpolationType };
...
extern string					 hashtag_font_file_name;
