...
void parseConfigurationFile( std::ifstream& confFin , std::ifstream&  scenarioFin ) {
  ...
  screen_font_file_name = "./" + project_name + "/fonts/usascii/arial/stb_font_arial_15_usascii.png";
  display_font_file_name = "./" + project_name + "/fonts/usascii/arial/stb_font_arial_25_usascii.png";
  hashtag_font_file_name = project_name + "/textures/hashtagFont.png";
