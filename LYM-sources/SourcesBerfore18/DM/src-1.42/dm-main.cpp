...
//   printf("-----------------------------------------------------------\n");
  ...
  DM_EnvironmentNode->window_width_scalar->SetValue( (float)DM_EnvironmentNode->DM_Window->getWindowWidth() );
  DM_EnvironmentNode->window_height_scalar->SetValue( (float)DM_EnvironmentNode->DM_Window->getWindowHeight() );

  printf( "Create Window %dx%d %s\n" , DM_EnvironmentNode->DM_Window->getWindowWidth() , DM_EnvironmentNode->DM_Window->getWindowHeight() , DM_EnvironmentNode->DM_Window->id );
