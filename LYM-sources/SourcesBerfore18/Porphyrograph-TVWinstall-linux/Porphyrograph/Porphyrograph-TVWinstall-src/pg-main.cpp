...
int main(int argcMain, char **argvMain) {
  ...
  pg_ReadAllDisplayMessages("./Data/TVW-data/messages/TVW-mirror/", "message_list.txt");

  // reads the hashtags
  pg_ReadAllHashtags("./Data/TVW-data/messages/TVW-mirror/", "hashtag_list.txt", "hashtag_colors.txt");

  // reads the hashtags font offets
  pg_initHashtagFontOffets("./ProjectsBefore18/" + project_name + "/textures/", "hashtagOffsets.txt");
