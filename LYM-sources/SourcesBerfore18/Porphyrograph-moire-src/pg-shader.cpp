...
GLint uniform_Drawing_fs_4fv_image_noisesxy01;
GLint uniform_Drawing_fs_4fv_image_noisesxy23;
GLint uniform_Drawing_fs_4fv_image_noisesxy45;
GLint uniform_Drawing_fs_4fv_mask_noisesxy01;
GLint uniform_Drawing_fs_4fv_mask_noisesxy23;
GLint uniform_Drawing_fs_4fv_mask_noisesxy45;
//GLint uniform_Drawing_fs_4fv_mask_inverse_noisesxy01;
//GLint uniform_Drawing_fs_4fv_mask_inverse_noisesxy23;
//GLint uniform_Drawing_fs_4fv_mask_inverse_noisesxy45;
GLint uniform_Drawing_fs_4fv_flashPart_flashTrack0Coefs_copyTrack12;
GLint uniform_Drawing_fs_4fv_trackdecay_clearLayer;
GLint uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef;
...
GLint uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc;
GLint uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers;
GLint uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo;
...
GLint uniform_Composition_texture_fs_lookupTable_display_font;  // large display message Font
GLint uniform_Composition_texture_fs_lookupTable_display_msg1_offset;  // large display message string
GLint uniform_Composition_texture_fs_lookupTable_display_msg2_offset;  // large display message string
...
#include "pg_shader_body_bind.cpp"
  ...
  uniform_Drawing_fs_4fv_image_noisesxy01
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_image_noisesxy01");
  uniform_Drawing_fs_4fv_image_noisesxy23 
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_image_noisesxy23");
  uniform_Drawing_fs_4fv_image_noisesxy45 
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_image_noisesxy45");
  uniform_Drawing_fs_4fv_mask_noisesxy01
	  = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mask_noisesxy01");
  uniform_Drawing_fs_4fv_mask_noisesxy23
	  = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mask_noisesxy23");
  uniform_Drawing_fs_4fv_mask_noisesxy45
	  = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mask_noisesxy45");
  //uniform_Drawing_fs_4fv_mask_inverse_noisesxy01
	 // = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mask_inverse_noisesxy01");
  //uniform_Drawing_fs_4fv_mask_inverse_noisesxy23
	 // = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mask_inverse_noisesxy23");
  //uniform_Drawing_fs_4fv_mask_inverse_noisesxy45
	 // = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mask_inverse_noisesxy45");
  ...
  uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef 
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef");
  ...
  uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc 
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc");
  uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers 
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers");
  uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo 
    = glGetUniformLocation(shader_Drawing_programme, "uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo");
...
// track FBO
  ...
  if( (uniform_Drawing_vp_model == -1)
	  ...
	  || (uniform_Drawing_fs_4fv_image_noisesxy01 == -1)
      || (uniform_Drawing_fs_4fv_image_noisesxy23 == -1)
      || (uniform_Drawing_fs_4fv_image_noisesxy45 == -1)
	  || (uniform_Drawing_fs_4fv_mask_noisesxy01 == -1)
	  || (uniform_Drawing_fs_4fv_mask_noisesxy23 == -1)
	  || (uniform_Drawing_fs_4fv_mask_noisesxy45 == -1)
	  //|| (uniform_Drawing_fs_4fv_mask_inverse_noisesxy01 == -1)
	  //|| (uniform_Drawing_fs_4fv_mask_inverse_noisesxy23 == -1)
	  //|| (uniform_Drawing_fs_4fv_mask_inverse_noisesxy45 == -1)
	  || (uniform_Drawing_fs_4fv_flashPart_flashTrack0Coefs_copyTrack12 == -1)
      || (uniform_Drawing_fs_4fv_trackdecay_clearLayer == -1)
      || (uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef == -1)
      ...
      || (uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc == -1)
      || (uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers == -1)
      || (uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo == -1)
     ...
     || (uniform_Drawing_fs_3fv_mouseTracks_RadiusY == -1)
	  ...
	  fprintf(stderr, "Could not bind uniforms Drawing uniform_Drawing_vp_model : %d, uniform_Drawing_vp_view : %d, uniform_Drawing_vp_proj : %d, uniform_Drawing_vp_2fv_width_height : %d, uniform_Drawing_fs_4fv_W_H_drawingStart_drawingStroke : %d, uniform_Drawing_fs_4fv_weights03 : %d, uniform_Drawing_fs_2fv_weights45 : %d, uniform_Drawing_fs_3fv_alphaSwap02 : %d, uniform_Drawing_fs_3fv_alphaSwap35 : %d, uniform_Drawing_fs_4fv_image_noisesxy01 : %d, uniform_Drawing_fs_4fv_image_noisesxy23 : %d, uniform_Drawing_fs_4fv_image_noisesxy45 : %d, uniform_Drawing_fs_4fv_mask_noisesxy01 : %d, uniform_Drawing_fs_4fv_mask_noisesxy23 : %d, uniform_Drawing_fs_4fv_mask_noisesxy45 : %d, uniform_Drawing_fs_4fv_flashPart_flashTrack0Coefs_copyTrack12 : %d, uniform_Drawing_fs_4fv_trackdecay_clearLayer : %d, uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef : %d, uniform_Drawing_fs_4fv_mouseTracks_y_videoH : %d, uniform_Drawing_fs_4fv_mouseTracks_x_prev_videoW : %d, uniform_Drawing_fs_4fv_mouseTracks_y_prev_videoThreshold : %d, uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc : %d, uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers : %d, uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo : %d, uniform_Drawing_fs_3fv_mouseTracks_Color_a : %d, uniform_Drawing_fs_4fv_mouseTracks_BrushID_Cursor : %d, uniform_Drawing_fs_3fv_mouseTracks_RadiusX : %d, uniform_Drawing_fs_3fv_mouseTracks_RadiusY : %d, uniform_Drawing_texture_fs_decal : %d, uniform_Drawing_texture_fs_lookupTable1 : %d, uniform_Drawing_texture_fs_lookupTable5 : %d, uniform_Drawing_texture_fs_lookupTable6 : %d\n", uniform_Drawing_vp_model, uniform_Drawing_vp_view, uniform_Drawing_vp_proj, uniform_Drawing_vp_2fv_width_height, uniform_Drawing_fs_4fv_W_H_drawingStart_drawingStroke, uniform_Drawing_fs_4fv_weights03, uniform_Drawing_fs_2fv_weights45, uniform_Drawing_fs_3fv_alphaSwap02, uniform_Drawing_fs_3fv_alphaSwap35, uniform_Drawing_fs_4fv_image_noisesxy01, uniform_Drawing_fs_4fv_image_noisesxy23, uniform_Drawing_fs_4fv_image_noisesxy45, uniform_Drawing_fs_4fv_mask_noisesxy01, uniform_Drawing_fs_4fv_mask_noisesxy23, uniform_Drawing_fs_4fv_mask_noisesxy45, uniform_Drawing_fs_4fv_flashPart_flashTrack0Coefs_copyTrack12, uniform_Drawing_fs_4fv_trackdecay_clearLayer, uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef, uniform_Drawing_fs_4fv_mouseTracks_y_videoH, uniform_Drawing_fs_4fv_mouseTracks_x_prev_videoW, uniform_Drawing_fs_4fv_mouseTracks_y_prev_videoThreshold, uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc, uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers, uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo, uniform_Drawing_fs_3fv_mouseTracks_Color_a, uniform_Drawing_fs_4fv_mouseTracks_BrushID_Cursor, uniform_Drawing_fs_3fv_mouseTracks_RadiusX, uniform_Drawing_fs_3fv_mouseTracks_RadiusY, uniform_Drawing_texture_fs_decal, uniform_Drawing_texture_fs_lookupTable1, uniform_Drawing_texture_fs_lookupTable5, uniform_Drawing_texture_fs_lookupTable6 );
#ifdef PG_WITH_CA
	  fprintf(stderr, "Could not bind uniforms Drawing uniform_Drawing_vp_model : %d, uniform_Drawing_vp_view : %d, uniform_Drawing_vp_proj : %d, uniform_Drawing_vp_2fv_width_height : %d, uniform_Drawing_fs_4fv_W_H_drawingStart_drawingStroke : %d, uniform_Drawing_fs_4fv_weights03 : %d, uniform_Drawing_fs_2fv_weights45 : %d, uniform_Drawing_fs_3fv_alphaSwap02 : %d, uniform_Drawing_fs_3fv_alphaSwap35 : %d, uniform_Drawing_fs_4fv_image_noisesxy01 : %d, uniform_Drawing_fs_4fv_image_noisesxy23 : %d, uniform_Drawing_fs_4fv_image_noisesxy45 : %d, uniform_Drawing_fs_4fv_mask_noisesxy01 : %d, uniform_Drawing_fs_4fv_mask_noisesxy23 : %d, uniform_Drawing_fs_4fv_mask_noisesxy45 : %d, uniform_Drawing_fs_4fv_flashPart_flashTrack0Coefs_copyTrack12 : %d, uniform_Drawing_fs_4fv_trackdecay_clearLayer : %d, uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef : %d, uniform_Drawing_fs_4fv_mouseTracks_y_videoH : %d, uniform_Drawing_fs_4fv_mouseTracks_x_prev_videoW : %d, uniform_Drawing_fs_4fv_mouseTracks_y_prev_videoThreshold : %d, uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc : %d, uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers : %d, uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo : %d, uniform_Drawing_fs_3fv_mouseTracks_Color_a : %d, uniform_Drawing_fs_4fv_mouseTracks_BrushID_Cursor : %d, uniform_Drawing_fs_3fv_mouseTracks_RadiusX : %d, uniform_Drawing_fs_3fv_mouseTracks_RadiusY : %d, uniform_Drawing_texture_fs_decal : %d, uniform_Drawing_texture_fs_lookupTable1 : %d, uniform_Drawing_texture_fs_lookupTable5 : %d, uniform_Drawing_texture_fs_lookupTable6 : %d, uniform_Drawing_fs_4fv_CAdecay_clearCA_flashCACoefs: %d\n", uniform_Drawing_vp_model, uniform_Drawing_vp_view, uniform_Drawing_vp_proj, uniform_Drawing_vp_2fv_width_height, uniform_Drawing_fs_4fv_W_H_drawingStart_drawingStroke, uniform_Drawing_fs_4fv_weights03, uniform_Drawing_fs_2fv_weights45, uniform_Drawing_fs_3fv_alphaSwap02, uniform_Drawing_fs_3fv_alphaSwap35, uniform_Drawing_fs_4fv_image_noisesxy01, uniform_Drawing_fs_4fv_image_noisesxy23, uniform_Drawing_fs_4fv_image_noisesxy45, uniform_Drawing_fs_4fv_mask_noisesxy01, uniform_Drawing_fs_4fv_mask_noisesxy23, uniform_Drawing_fs_4fv_mask_noisesxy45, uniform_Drawing_fs_4fv_flashPart_flashTrack0Coefs_copyTrack12, uniform_Drawing_fs_4fv_trackdecay_clearLayer, uniform_Drawing_fs_4fv_mouseTracks_x_flashBackCoef, uniform_Drawing_fs_4fv_mouseTracks_y_videoH, uniform_Drawing_fs_4fv_mouseTracks_x_prev_videoW, uniform_Drawing_fs_4fv_mouseTracks_y_prev_videoThreshold, uniform_Drawing_fs_4fv_mouseTracks_Color_r_partAcc, uniform_Drawing_fs_4fv_mouseTracks_Color_g_clearAllLayers, uniform_Drawing_fs_4fv_mouseTracks_Color_b_frameNo, uniform_Drawing_fs_3fv_mouseTracks_Color_a, uniform_Drawing_fs_4fv_mouseTracks_BrushID_Cursor, uniform_Drawing_fs_3fv_mouseTracks_RadiusX, uniform_Drawing_fs_3fv_mouseTracks_RadiusY, uniform_Drawing_texture_fs_decal, uniform_Drawing_texture_fs_lookupTable1, uniform_Drawing_texture_fs_lookupTable5, uniform_Drawing_texture_fs_lookupTable6, uniform_Drawing_fs_4fv_CAdecay_clearCA_flashCACoefs);
#endif
#if PG_NB_TRACKS >= 2
...
#endif
	  fprintf(stderr, "Could not bind uniforms uniform_Drawing_fs_3fv_mouseTracuniform_Drawing_texture_fs_lookupTable10 : %d, uniform_Drawing_texture_fs_lookupTable11 : %d, uniform_Drawing_texture_fs_lookupTable12 : %d, uniform_Drawing_texture_fs_lookupTable13 : %d, uniform_Drawing_texture_fs_lookupTable14 : %d, uniform_Drawing_texture_fs_lookupTable15 : %d, uniform_Drawing_texture_fs_lookupTable16 : %d, uniform_Drawing_texture_fs_lookupTable17 : %d, uniform_Drawing_texture_fs_lookupTable20 : %d, uniform_Drawing_texture_fs_lookupTable21 : %d, uniform_Drawing_texture_fs_lookupTable22 : %d, uniform_Drawing_texture_fs_lookupTable23 : %d, uniform_Drawing_texture_fs_lookupTable24 : %d, uniform_Drawing_texture_fs_lookupTable25 : %d\n", uniform_Drawing_texture_fs_lookupTable10, uniform_Drawing_texture_fs_lookupTable11, uniform_Drawing_texture_fs_lookupTable12, uniform_Drawing_texture_fs_lookupTable13, uniform_Drawing_texture_fs_lookupTable14, uniform_Drawing_texture_fs_lookupTable15, uniform_Drawing_texture_fs_lookupTable16, uniform_Drawing_texture_fs_lookupTable17, uniform_Drawing_texture_fs_lookupTable20, uniform_Drawing_texture_fs_lookupTable21, uniform_Drawing_texture_fs_lookupTable22, uniform_Drawing_texture_fs_lookupTable23, uniform_Drawing_texture_fs_lookupTable24, uniform_Drawing_texture_fs_lookupTable25);
 }
  ...
  uniform_Composition_texture_fs_lookupTable_display_font
	  = glGetUniformLocation(shader_Composition_programme, "fs_lookupTable_display_font");  // message Font
  uniform_Composition_texture_fs_lookupTable_display_msg1_offset
	  = glGetUniformLocation(shader_Composition_programme, "fs_lookupTable_display_msg1_offset");  // message string
  uniform_Composition_texture_fs_lookupTable_display_msg2_offset
	  = glGetUniformLocation(shader_Composition_programme, "fs_lookupTable_display_msg2_offset");  // message string
  if ((uniform_Composition_vp_proj == -1)
	   ...
	   || (uniform_Composition_texture_fs_lookupTable_display_font == -1)
	   || (uniform_Composition_texture_fs_lookupTable_display_msg1_offset == -1)
	   || (uniform_Composition_texture_fs_lookupTable_display_msg2_offset == -1)
	   ) {
#if PG_NB_TRACKS >= 2
...
#endif
	  fprintf(stderr, "Could not bind uniforms Composition uniform_Composition_vp_proj : %d, uniform_Composition_vp_view : %d, uniform_Composition_vp_model : %d, uniform_Composition_fs_4fv_height_screenMsgTransp_Text1_2_Alpha : %d, uniform_Composition_texture_fs_decal : %d, uniform_Composition_texture_fs_lookupTable4 : %d, uniform_Composition_texture_fs_lookupTable_screen_font : %d, uniform_Composition_texture_fs_lookupTable_screen_msg_offset : %d, uniform_Composition_texture_fs_lookupTable_display_font : %d, uniform_Composition_texture_fs_lookupTable_display_msg1_offset : %d, uniform_Composition_texture_fs_lookupTable_display_msg2_offset : %d\n", uniform_Composition_vp_proj, uniform_Composition_vp_view, uniform_Composition_vp_model, uniform_Composition_fs_4fv_height_screenMsgTransp_Text1_2_Alpha, uniform_Composition_texture_fs_decal, uniform_Composition_texture_fs_lookupTable4, uniform_Composition_texture_fs_lookupTable_screen_font, uniform_Composition_texture_fs_lookupTable_screen_msg_offset, uniform_Composition_texture_fs_lookupTable_display_font, uniform_Composition_texture_fs_lookupTable_display_msg1_offset, uniform_Composition_texture_fs_lookupTable_display_msg2_offset);
    // return 0;
  }
