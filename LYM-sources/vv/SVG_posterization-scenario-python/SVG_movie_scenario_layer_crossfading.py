...
import vv_lib
import SVG_movie_layer_crossfading

USAGE = '''/mnt/d/sync.com/Sync/LYM-sources/SVG_movie/SVG_posterization-scenario/SVG_movie_scenario_layer_crossfading.pl -i scenario_file
