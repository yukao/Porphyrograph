...
def main(main_args) :
	...
	for idx, row in enumerate(csv_reader):
		...
		os.system("convert "+image_file_name+"  -resize 1920x1080 -colorspace RGB -channel A -evaluate multiply 0.25 +channel "+os.path.join(storage_dir_for_drawing_frames,"drawing_frame"+marker_frame_no_string+".png"))
		marker_frame_no_string = "_%03d" % (marker_frame_no + 1)
		os.system("convert "+image_file_name+"  -resize 1920x1080 -colorspace RGB -channel A -evaluate multiply 0.5 +channel "+os.path.join(storage_dir_for_drawing_frames,"drawing_frame"+marker_frame_no_string+".png"))
		marker_frame_no_string = "_%03d" % (marker_frame_no + 2)
		os.system("convert "+image_file_name+"  -resize 1920x1080 -colorspace RGB -channel A -evaluate multiply 0.75 +channel "+os.path.join(storage_dir_for_drawing_frames,"drawing_frame"+marker_frame_no_string+".png"))
		marker_frame_no_string = "_%03d" % (marker_frame_no + 3)
		os.system("convert "+image_file_name+"  -resize 1920x1080 -colorspace RGB "+os.path.join(storage_dir_for_drawing_frames,"drawing_frame"+marker_frame_no_string+".png"))
		...
		os.system("convert "+image_file_name+"  -resize 1920x1080 -colorspace RGB -channel A -evaluate multiply 0.66 +channel "+os.path.join(storage_dir_for_drawing_frames,"drawing_frame"+marker_frame_no_string+".png"))
		marker_frame_no_string = "_%03d" % (marker_frame_no + 8)
		os.system("convert "+image_file_name+"  -resize 1920x1080 -colorspace RGB -channel A -evaluate multiply 0.33 +channel "+os.path.join(storage_dir_for_drawing_frames,"drawing_frame"+marker_frame_no_string+".png"))
