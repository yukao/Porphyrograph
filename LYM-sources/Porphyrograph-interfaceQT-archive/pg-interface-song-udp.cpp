...
#ifdef TVW
        for(int indDisplay = _TVW_display ; indDisplay <= _TVW_Pulse_display ; indDisplay++) {
            tabDisplays[static_cast<DisplayType>(indDisplay)]
                    ->colorPalette->setMixedColor(
                        args[0], args[1], args[2], 0);
        }
    ...
    for(unsigned int indDisplay = 0; indDisplay < _NumberOfDisplays; indDisplay++) {
        ...
        case _Beat_display:
            ...
            if(OSCTagString == "/pixel_mode_can" && (nbargts + 1) >= 2
                    && tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData].size() >= 1
                    && tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0] ) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0]->setText("X");
                    tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0]->getAssociatedSingleLabel()->setText("noPix");
                }
                else if(value == 1) {
                    tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0]->setText("pixel");
                    tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0]->getAssociatedSingleLabel()->setText("pi");
                }
                else if(value == 2) {
                    tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0]->setText("fireWk");
                    tabControllers[_Beat_display]->mainButtons[_pixelModeButtonsBeatData][0]->getAssociatedSingleLabel()->setText("FW");
                }
            }
            else if(OSCTagString == "/pen_grey_can" && (nbargts + 1) >= 2
                    && tabControllers[_Beat_display]->mainButtons[_penBWButtonsBeatData].size() >= 1
                    && tabControllers[_Beat_display]->mainButtons[_penBWButtonsBeatData][0] ) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Beat_display]->mainButtons[_penBWButtonsBeatData][0]->setText("Black");
                    tabControllers[_Beat_display]->mainButtons[_penBWButtonsBeatData][0]->getAssociatedSingleLabel()->setText("B");
                }
                else {
                    tabControllers[_Beat_display]->mainButtons[_penBWButtonsBeatData][0]->setText("White");
                    tabControllers[_Beat_display]->mainButtons[_penBWButtonsBeatData][0]->getAssociatedSingleLabel()->setText("W");
                }
            }
            else if(OSCTagString == "/repop_grey_can" && (nbargts + 1) >= 2
                    && tabControllers[_Beat_display]->mainButtons[_repopBWButtonsBeatData].size() >= 1
                    && tabControllers[_Beat_display]->mainButtons[_repopBWButtonsBeatData][0]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Beat_display]->mainButtons[_repopBWButtonsBeatData][0]->setText("Black");
                    tabControllers[_Beat_display]->mainButtons[_repopBWButtonsBeatData][0]->getAssociatedSingleLabel()->setText("B");
                }
                else {
                    tabControllers[_Beat_display]->mainButtons[_repopBWButtonsBeatData][0]->setText("White");
                    tabControllers[_Beat_display]->mainButtons[_repopBWButtonsBeatData][0]->getAssociatedSingleLabel()->setText("W");
                }
            }
            else if(OSCTagString.startsWith("/pen_colorPreset_name_can") && (nbargts + 1) >= 2) {
                int value = OSCTagString.right(1).toInt();
                if(value < (int)tabControllers[_Beat_display]->mainButtons[_penPaletteButtonsBeatData].size()
                        && tabControllers[_Beat_display]->mainButtons[_penPaletteButtonsBeatData][value]) {
                    tabControllers[_Beat_display]->mainButtons[_penPaletteButtonsBeatData][value]->setText(firstArgtString);
                    tabControllers[_Beat_display]->mainButtons[_penPaletteButtonsBeatData][value]->getAssociatedSingleLabel()->setText(firstArgtString);
                }
            }
            break;
        ...
        case _Mixer_display:
            ...
            if(OSCTagString == "/currentPhotoTrack_can" && (nbargts + 1) >= 2
                    && tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData].size() >= 1
                    && tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->setText("Photo BG");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->getAssociatedSingleLabel()->setText("Ph0");
                }
                else if(value == 1) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->setText("Photo T1");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->getAssociatedSingleLabel()->setText("Ph1");
                }
                else if(value == 2) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->setText("Photo T2");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->getAssociatedSingleLabel()->setText("Ph2");
                }
                else if(value == 3) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->setText("Photo T3");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][0]->getAssociatedSingleLabel()->setText("Ph3");
                }
            }
            else if(OSCTagString == "/currentVideoTrack_can" && (nbargts + 1) >= 2
                    && tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData].size() >= 2
                    && tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->setText("Video BG");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->getAssociatedSingleLabel()->setText("Vi0");
                }
                else if(value == 1) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->setText("Video T1");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->getAssociatedSingleLabel()->setText("Vi1");
                }
                else if(value == 2) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->setText("Video T2");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->getAssociatedSingleLabel()->setText("Vi2");
                }
                else if(value == 3) {
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->setText("Video T3");
                    tabControllers[_Mixer_display]->mainButtons[_TracksButtonsMixerData][1]->getAssociatedSingleLabel()->setText("Vi3");
                }
            }
            else if(OSCTagString == "/freeze_can" && (nbargts + 1) >= 2
                    && tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData].size() >= 1
                    && tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][0]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][0]->setText("OFF");
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][0]->getAssociatedSingleLabel()->setText("Off");
                }
                else {
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][0]->setText("ON");
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][0]->getAssociatedSingleLabel()->setText("On");
                }
            }
            else if(OSCTagString == "/invertAllLayers_can" && (nbargts + 1) >= 2
                    && tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData].size() >= 2
                    && tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][1]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][1]->setText("OFF");
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][1]->getAssociatedSingleLabel()->setText("Off");
                }
                else {
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][1]->setText("ON");
                    tabControllers[_Mixer_display]->mainButtons[_freezeBottomButtonsMixerData][1]->getAssociatedSingleLabel()->setText("On");
                }
            }
            break;
        ...
        case _FX_display:
            ...
            if(OSCTagString == "/soundtrack_shortName_can" && (nbargts + 1) >= 2
                    && tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData].size() >= 1
                    && tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][0]) {
                tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][0]->setText(firstArgtString);
                tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][0]->getAssociatedSingleLabel()->setText(firstArgtString);
            }
            else if(OSCTagString == "/movie_shortName_can" && (nbargts + 1) >= 2
                    && tabControllers[_FX_display]->mainButtons[_mediaPlusButtonsFXData].size() >= 2
                    && tabControllers[_FX_display]->mainButtons[_mediaPlusButtonsFXData][1]) {
                tabControllers[_FX_display]->mainButtons[_mediaPlusButtonsFXData][1]->setText(firstArgtString);
                tabControllers[_FX_display]->mainButtons[_mediaPlusButtonsFXData][1]->getAssociatedSingleLabel()->setText(firstArgtString);
            }
            else if(OSCTagString == "/soundtrack_onOff_can" && (nbargts + 1) >= 2
                    && tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData].size() >= 2
                    && tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][1]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][1]->setText("OFF");
                    tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][1]->getAssociatedSingleLabel()->setText("X");
                }
                else {
                    tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][1]->setText("ON");
                    tabControllers[_FX_display]->mainButtons[_soundSampleButtonsFXData][1]->getAssociatedSingleLabel()->setText("ON");
                }
            }
            else if(OSCTagString == "/adc_onOff_can" && (nbargts + 1) >= 2
                    && tabControllers[_FX_display]->mainButtons[_micOnOffButtonsFXData].size() >= 1
                    && tabControllers[_FX_display]->mainButtons[_micOnOffButtonsFXData][0]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_FX_display]->mainButtons[_micOnOffButtonsFXData][0]->setText("OFF");
                    tabControllers[_FX_display]->mainButtons[_micOnOffButtonsFXData][0]->getAssociatedSingleLabel()->setText("X");
                }
                else {
                    tabControllers[_FX_display]->mainButtons[_micOnOffButtonsFXData][0]->setText("ON");
                    tabControllers[_FX_display]->mainButtons[_micOnOffButtonsFXData][0]->getAssociatedSingleLabel()->setText("ON");
                }
            }
            ...
            //////////////////////////////////////////////////////////////
            // text of the buttons and labels
            // qDebug() << "Text "; // << std::endl;
            else if(OSCTagString == "/CASubType_can" && (nbargts + 1) >= 2
                    && tabControllers[_FX_display]->mainButtons[_CATypeButtonFXsData].size() >= 1
                    && tabControllers[_FX_display]->mainButtons[_CATypeButtonFXsData][0]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_FX_display]->mainButtons[_CATypeButtonFXsData][0]->setText("OFF");
                    tabControllers[_FX_display]->mainButtons[_CATypeButtonFXsData][0]->getAssociatedSingleLabel()->setText("X");
                }
                else {
                    tabControllers[_FX_display]->mainButtons[_CATypeButtonFXsData][0]->setText("ON");
                    tabControllers[_FX_display]->mainButtons[_CATypeButtonFXsData][0]->getAssociatedSingleLabel()->setText("ON");
                }
            }
            else if(OSCTagString == "/cameraCumul_can" && (nbargts + 1) >= 2
                    && tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData].size() >= 1
                    && tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->setText("CaCu:Off");
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->getAssociatedSingleLabel()->setText("X");
                }
                else if(value == 1) {
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->setText("CaCu:Add");
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->getAssociatedSingleLabel()->setText("Add");
                }
                else if(value == 2) {
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->setText("CaCu:Stmp");
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->getAssociatedSingleLabel()->setText("Stp");
                }
                else {
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->setText("CaCu:XOR");
                    tabControllers[_FX_display]->mainButtons[_cameraCumulButtonsFXData][0]->getAssociatedSingleLabel()->setText("XOR");
                }
            }
            break;
        ...
        case _TVW_display:
            if(OSCTagString == "/pen_grey_can" && (nbargts + 1) >= 2
                    && tabControllers[_TVW_display]->mainButtons[_PenGreyButtonTVWsData].size() >= 1
                    && tabControllers[_TVW_display]->mainButtons[_PenGreyButtonTVWsData][0] ) {
                int value = int(args[0]);
                if(value == 0) {
                    tabControllers[_TVW_display]->mainButtons[_PenGreyButtonTVWsData][0]->setText("Black");
                    tabControllers[_TVW_display]->mainButtons[_PenGreyButtonTVWsData][0]->getAssociatedSingleLabel()->setText("B");
                }
                else {
                    tabControllers[_TVW_display]->mainButtons[_PenGreyButtonTVWsData][0]->setText("White");
                    tabControllers[_TVW_display]->mainButtons[_PenGreyButtonTVWsData][0]->getAssociatedSingleLabel()->setText("W");
                }
            }
            else if(OSCTagString.startsWith("/pen_colorPreset_name_can") && (nbargts + 1) >= 2) {
                int value = OSCTagString.right(1).toInt();
                if(value < (int)tabControllers[_TVW_display]->mainButtons[_PenColorTVWData].size()
                        && tabControllers[_TVW_display]->mainButtons[_PenColorTVWData][value]) {
                    tabControllers[_TVW_display]->mainButtons[_PenColorTVWData][value]->setText(firstArgtString);
                    tabControllers[_TVW_display]->mainButtons[_PenColorTVWData][value]->getAssociatedSingleLabel()->setText(firstArgtString);
                }
            }
            break;
#endif
